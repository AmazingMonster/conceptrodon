...
From the template head of `boost::mp11::mp_bind_front`, we can see that one kind of metafunction gets special treatment, namely, the metafunctions acceptable as its first template argument.
