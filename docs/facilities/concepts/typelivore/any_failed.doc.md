...
# `Typelivore::AnyFailed`

<p style='text-align: right;'><a href="../../concepts.md#typelivore-any-failed">To Index</a></p>

## Description

`Typelivore::AnyFailed` accepts a callable type predicate and a list of variables.
...
`AnyFailed` turns a fold expression of a callable type predicate over `||` into a concept so that it can be used for subsumption.
...
- [Example](../../../code/facilities/concepts/typelivore/any_failed/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/typelivore/any_failed.hpp)
- [Unit test](../../../../tests/unit/concepts/typelivore/any_failed.test.hpp)
