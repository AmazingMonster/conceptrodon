...
# `Typelivore::AllPassed`

<p style='text-align: right;'><a href="../../concepts.md#typelivore-all-passed">To Index</a></p>

## Description

`Typelivore::AllPassed` accepts a callable type predicate and a list of variables.
...
`AllPassed` turns a fold expression of a callable type predicate over `&&` into a concept so that it can be used for subsumption.
...
- [Example](../../../code/facilities/concepts/typelivore/all_passed/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/typelivore/all_passed.hpp)
- [Unit test](../../../../tests/unit/concepts/typelivore/all_passed.test.hpp)
