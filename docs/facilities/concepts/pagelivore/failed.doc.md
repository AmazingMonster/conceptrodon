...
<p style='text-align: right;'><a href="../../concepts.md#pagelivore-failed">To Index</a></p>

## Description

`Pagelivore::Failed` accepts a class template predicate and a list of variables.
...
- [Example](../../../code/facilities/concepts/pagelivore/failed/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/pagelivore/failed.hpp)
- [Unit test](../../../../tests/unit/concepts/pagelivore/failed.test.hpp)
