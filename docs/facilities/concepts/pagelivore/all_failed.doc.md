...
# `Pagelivore::AllFailed`

<p style='text-align: right;'><a href="../../concepts.md#pagelivore-all-failed">To Index</a></p>

## Description

`Pagelivore::AllFailed` accepts a class template predicate and a list of variables.
...
concept AllFailed = (...&&(not Predicate<Variables>::value));
```

## Links

- [Example](../../../code/facilities/concepts/pagelivore/all_failed/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/pagelivore/all_failed.hpp)
- [Unit test](../../../../tests/unit/concepts/pagelivore/all_failed.test.hpp)
