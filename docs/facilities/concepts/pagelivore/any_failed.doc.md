...
# `Pagelivore::AnyFailed`

<p style='text-align: right;'><a href="../../concepts.md#pagelivore-any-failed">To Index</a></p>

## Description

`Pagelivore::AnyFailed` accepts a class template predicate and a list of variables.
...
- [Example](../../../code/facilities/concepts/pagelivore/any_failed/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/pagelivore/any_failed.hpp)
- [Unit test](../../../../tests/unit/concepts/pagelivore/any_failed.test.hpp)
