...
<p style='text-align: right;'><a href="../../concepts.md#mouldivore-passing">To Index</a></p>

## Description

`Mouldivore::Passing` accepts an element and a class template predicate.
...
concept Passing = REQUIREMENT;
```

## Examples

`Passing` turns a class template predicate into a concept so that it can be used for subsumption.
...
- [Example](../../../code/facilities/concepts/mouldivore/passing/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/mouldivore/passing.hpp)
- [Unit test](../../../../tests/unit/concepts/mouldivore/passing.test.hpp)
