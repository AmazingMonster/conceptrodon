...
# `Varybivore::AllFailed`

<p style='text-align: right;'><a href="../../concepts.md#varybivore-all-failed">To Index</a></p>

## Description

`Varybivore::AllFailed` accepts a callable predicate and a list of variables.
...
`AllFailed` turns a fold expression of a callable predicate over `&&` into a concept so that it can be used for subsumption.
...
- [Example](../../../code/facilities/concepts/varybivore/all_failed/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/varybivore/all_failed.hpp)
- [Unit test](../../../../tests/unit/concepts/varybivore/all_failed.test.hpp)
