...
# `Varybivore::AllPassed`

<p style='text-align: right;'><a href="../../concepts.md#varybivore-all-passed">To Index</a></p>

## Description

`Varybivore::AllPassed` accepts a callable predicate and a list of variables.
...
`AllPassed` turns a fold expression of a callable predicate over `&&` into a concept so that it can be used for subsumption.
...
- [Example](../../../code/facilities/concepts/varybivore/all_passed/implementation.hpp)
- [Source code](../../../../conceptrodon/concepts/varybivore/all_passed.hpp)
- [Unit test](../../../../tests/unit/concepts/varybivore/all_passed.test.hpp)
