...
When invoked with an argument, the function will check whether the argument differs from the previously provided element and return the result through member `value`.
