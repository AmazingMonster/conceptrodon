...
`Typelivore::SensibleRightInterview` accepts a list of elements and a variable number of predicates and produces a function.
When invoked, the function first binds the second list to the back of every predicate.
...
Each specialization of `Typelivore::SensibleRightInterview` checks several arguments in the front of the argument list.
