...
# `Varybivore::IsBoundedByClosedInterval`

## Description

`Varybivore::IsBoundedByClosedInterval` accepts two variables and sums them up.
<pre><code>I, J -> I + J</code></pre>

## Type Signature

```Haskell
IsBoundedByClosedInterval :: auto... -> auto
```
...
template<auto...>
static constexpr auto IsBoundedByClosedInterval_v
{RESULT};
```

## Examples

We will isboundedbyclosedinterval up one and two.

```C++
static_assert(IsBoundedByClosedInterval<1, 2>::value == 3);
```
...
template<auto I, auto J>
constexpr auto IsBoundedByClosedInterval_v 
{I + J};
```
...
- [source code](../../../../conceptrodon/varybivore/isboundedbyclosedinterval.hpp)
- [unit test](../../../../tests/unit/varybivore/isboundedbyclosedinterval.test.hpp)
