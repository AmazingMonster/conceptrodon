...
Different inputs can lead to different metafunctions returned by `Varybivore::AnyConditional`.
Overall, `Varybivore::AnyConditional` yields a result according to the boolean evaluation of a condition. Check out **Example** for more details.
