...
It returns twelve continuation functions and two commitment functions.
...
using Metafunction = Trip<Operation>::Mold<Args...>;
...
The implementation of `Trip` relies on a helper function called `LoadTrip` to keep a record of user inputs.
...
// Then, we pass the extended `Items` back to `LoadTrip`,
// waiting for more inputs.
    template<typename...Elements>
    using Mold = LoadTrip<Operation, Items..., Capsule<Elements...>>;
...
// waiting for more inputs.
    ...
    using Page = LoadTrip<Operation, Items..., Shuttle<Variables...>>;

    struct Commit
    {
        template<template<auto...> class...Sequences>
// When finally initiating the operation, we invoke the tripped layer.
...
struct Trip: public LoadTrip<Operation> {};
```
...
- [source code](../../../../conceptrodon/descend/raillivore/trip.hpp)
