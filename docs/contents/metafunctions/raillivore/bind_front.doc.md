...
Its first layer accepts a list of sequences and returns a metafunction such that when invoked, the previously provided sequences will be concatenated to the front of the argument list;
...
Here's the entire implementation of `Raillivore::BindFront`:
...
- [unit test](../../../../tests/unit/raillivore/bind_front.test.hpp)
