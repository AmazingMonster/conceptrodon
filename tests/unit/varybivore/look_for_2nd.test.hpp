...
#ifndef CONCEPTRODON_TESTS_UNIT_VARYBIVORE_LOOK_FOR_2ND_H
#define CONCEPTRODON_TESTS_UNIT_VARYBIVORE_LOOK_FOR_2ND_H
...
template<int I>
constexpr auto Found = LookFor<SHEEP_SPROUT(240)>
