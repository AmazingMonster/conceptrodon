...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_TRANSFORM_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_TRANSFORM_H
...
SAME_TYPE(Transform<Tester>::Road<IsEven>::Road<PlusOne>::Mold<SHEEP_SPROUT(240)>);
