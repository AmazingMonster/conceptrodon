...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_FOLD_LEFT_2ND_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_FOLD_LEFT_2ND_H
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
SAME_TYPE(FoldLeft<BinaryOperation>::Mold<std::integral_constant<int, 1>>::Slash::ProtoMold<SHEEP_SPROUT(240)>::type);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
