#ifndef CONCEPTRODON_MOULDIVORE_TEST_INDEPENDENT_RIGHT_INTERVIEW_H
#define CONCEPTRODON_MOULDIVORE_TEST_INDEPENDENT_RIGHT_INTERVIEW_H
...
template<int I>
constexpr auto FailInterviewed = IndependentRightInterview<std::is_base_of>
...
template<int I>
constexpr auto Interviewed = IndependentRightInterview<std::is_base_of>
::Mold<Integer<I>>
::template Mold_v<SHEEP_SPROUT(120)>;
