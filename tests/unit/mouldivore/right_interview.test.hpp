...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_RIGHT_INTERVIEW_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_RIGHT_INTERVIEW_H
...
template<int I>
constexpr auto FailInterviewed = RightInterview<std::is_base_of>
...
template<int I>
constexpr auto Interviewed = RightInterview<std::is_base_of>
::Mold<Integer<I>>
::template Mold_v<SHEEP_SPROUT(120)>;
