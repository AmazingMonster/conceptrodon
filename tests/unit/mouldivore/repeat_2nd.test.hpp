...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_REPEAT_2ND_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_REPEAT_2ND_H
...
SAME_TYPE(Repeat<Capsule>::Page<240>::Mold<int, float, double>);
