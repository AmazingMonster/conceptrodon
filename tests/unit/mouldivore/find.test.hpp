...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_FIND_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_FIND_H
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
template<int I>
constexpr auto FailFound = Find<Typelivore::IsSameAs<std::integral_constant<int, -1>>::template Mold>
