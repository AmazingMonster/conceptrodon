...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_GAUGE_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_GAUGE_H
...
SAME_TYPE(Gauge<SHEEP_SPROUT(240)>::Mold_t<LLAMA_SPROUT(240)>);
