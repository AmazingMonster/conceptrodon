...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_MODIFY_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_MODIFY_H
...
SAME_TYPE(Modify<Tester>::Road<PlusOne>::Page<SHEEP_SPROUT(120, *2)>::Mold<LLAMA_SPROUT(240)>);
