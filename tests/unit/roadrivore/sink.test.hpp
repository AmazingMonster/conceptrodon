...
#ifndef CONCEPTRODON_TESTS_UNIT_ROADRIVORE_SINK_H
#define CONCEPTRODON_TESTS_UNIT_ROADRIVORE_SINK_H

#include "conceptrodon/descend/roadrivore/sink.hpp"
...
VALID(Sink<Tester>::Mold<>::Page<>::Road<>::Rail<>::Flow<>::Sail<>::Snow<>::Hail<>::Lull<>::Calm<>::Grit<>::Will<>::Glow<>::Dawn<>::Realm::Road<>::value);
VALID(Sink<Tester>::Mold<>::Mold<std::true_type>::Realm::Road<>::value);
VALID(Sink<Tester>::Page<true>::Realm::Road<std::tuple>::value);
