...
#ifndef CONCEPTRODON_TESTS_UNIT_ROADRIVORE_SKID_H
#define CONCEPTRODON_TESTS_UNIT_ROADRIVORE_SKID_H

#include "conceptrodon/descend/roadrivore/skid.hpp"
...
VALID(Skid<Tester>::Mold<>::Page<>::R_ad<>::Rail<>::Flow<>::Sail<>::Snow<>::Hail<>::Lull<>::Calm<>::Grit<>::Will<>::Glow<>::Dawn<>::Road<>::value);
VALID(Skid<Tester>::Mold<>::Mold<std::true_type>::Road<>::value);
VALID(Skid<Tester>::Page<true>::Road<std::tuple>::value);
