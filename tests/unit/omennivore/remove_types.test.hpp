...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_REMOVE_TYPES_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_REMOVE_TYPES_H
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
SAME_TYPE(RemoveTypes<std::make_index_sequence<0>, ALKANE_SPROUT(119)>::Mold_t<SHEEP_SPROUT(240)>);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
