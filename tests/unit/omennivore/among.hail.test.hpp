...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_HAIL_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_HAIL_H
...
using Amongus = Among<Persist<SHEEP_SPROUT(240)>>;
