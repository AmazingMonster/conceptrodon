#ifndef CONCEPTRODON_OMENNIVORE_TEST_MODIFY_VARIABLES_H
#define CONCEPTRODON_OMENNIVORE_TEST_MODIFY_VARIABLES_H
...
SAME_TYPE(ModifyVariables<std::make_index_sequence<0>, ALKANE_SPROUT(119)>::Rail<PlusOne>::Page_t<SHEEP_SPROUT(240)>);
