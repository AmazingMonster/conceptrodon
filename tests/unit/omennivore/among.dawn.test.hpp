...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_DAWN_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_DAWN_H
...
using Amongus = Among<DawnHolder<SHEEP_SPROUT(240)>>;
