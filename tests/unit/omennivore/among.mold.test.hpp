...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_MOLD_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_MOLD_H
...
using Amongus = Among<Reverie<SHEEP_SPROUT(240)>>;
