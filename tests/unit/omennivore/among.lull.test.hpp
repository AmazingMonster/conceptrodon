...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_LULL_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_AMONG_LULL_H
...
using Amongus = Among<Sunrise<SHEEP_SPROUT(240)>>;
