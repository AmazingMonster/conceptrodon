...
INVALID(IsDawnful<Morning<>>::value);
INVALID(IsDawnful_v<Morning<>>);

INVALID(IsDawnful<Arcadia<>>::value);
INVALID(IsDawnful_v<Arcadia<>>);

VALID(IsDawnful<Nirvana<>>::value);
VALID(IsDawnful_v<Nirvana<>>);
