...
VALID(IsRailful<Phantom<>>::value);
VALID(IsRailful_v<Phantom<>>);
...
INVALID(IsRailful<Arcadia<>>::value);
INVALID(IsRailful_v<Arcadia<>>);

INVALID(IsRailful<Nirvana<>>::value);
INVALID(IsRailful_v<Nirvana<>>);
