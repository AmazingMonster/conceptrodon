...
#ifndef CONCEPTRODON_TESTS_UNIT_RAILLIVORE_SINK_H
#define CONCEPTRODON_TESTS_UNIT_RAILLIVORE_SINK_H

#include "conceptrodon/descend/raillivore/sink.hpp"
...
VALID(Sink<Tester>::Mold<>::Page<>::Road<>::Rail<>::Flow<>::Sail<>::Snow<>::Hail<>::Lull<>::Calm<>::Grit<>::Will<>::Glow<>::Dawn<>::Realm::Rail<>::value);
VALID(Sink<Tester>::Mold<>::Mold<std::true_type>::Realm::Rail<>::value);
VALID(Sink<Tester>::Page<true>::Realm::Rail<std::index_sequence>::value);
