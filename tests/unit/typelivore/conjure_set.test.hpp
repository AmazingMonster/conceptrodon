#ifndef CONCEPTRODON_TYPELIVORE_TEST_CONJURE_SET_H
#define CONCEPTRODON_TYPELIVORE_TEST_CONJURE_SET_H
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
SAME_TYPE(ConjureSet<SHEEP_SPROUT(240), std::integral_constant<int, 39>>::type);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
