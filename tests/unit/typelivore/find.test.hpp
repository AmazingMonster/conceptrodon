...
#ifndef CONCEPTRODON_TESTS_UNIT_TYPELIVORE_FIND_H
#define CONCEPTRODON_TESTS_UNIT_TYPELIVORE_FIND_H
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
template<int I>
constexpr auto FailFound = Find<SHEEP_SPROUT(120), std::integral_constant<int, I>>
