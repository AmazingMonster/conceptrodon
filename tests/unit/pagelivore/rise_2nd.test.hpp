...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_RISE_2ND_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_RISE_2ND_H
...
SAME_TYPE(Rise<>::Page<SHEEP_SPROUT(200, +40), SHEEP_SPROUT(40)>);
