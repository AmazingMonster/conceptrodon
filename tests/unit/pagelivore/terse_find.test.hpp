...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_TERSE_FIND_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_TERSE_FIND_H
...
template<int I>
constexpr auto Found = TerseFind<Varybivore::IsSameAs<I>::template Page>
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep.hpp"
template<int I>
constexpr auto FailFound = TerseFind<Varybivore::IsSameAs<-1>::template Page>
