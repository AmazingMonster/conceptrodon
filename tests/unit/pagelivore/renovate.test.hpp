...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_RENOVATE_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_RENOVATE_H
...
SAME_TYPE(Renovate<SHEEP_SPROUT(240)>::Page_t<LLAMA_SPROUT(240)>);
