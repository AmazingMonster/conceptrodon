...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_FILTER_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_FILTER_H

#include "conceptrodon/metafunctions/pagelivore/cognate_filter.hpp"
