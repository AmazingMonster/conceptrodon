...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_MODIFY_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_MODIFY_H

#include <utility>

#include "conceptrodon/metafunctions/pagelivore/cognate_modify.hpp"
...
SAME_TYPE(CognateModify<Operation>::Rail<PlusOne>::Page<SHEEP_SPROUT(120, *2)>::Page<SHEEP_SPROUT(240)>);
