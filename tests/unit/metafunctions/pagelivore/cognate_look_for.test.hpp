...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_COGNATE_LOOK_FOR_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_COGNATE_LOOK_FOR_H

#include <concepts>
#include <type_traits>
#include "conceptrodon/pagelivore/cognate_look_for.hpp"
...
template<int I>
constexpr auto Found = CognateLookFor<Varybivore::IsSameAs<I>::template Page>
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep.hpp"
template<int I>
constexpr auto FailFound = CognateLookFor<Varybivore::IsSameAs<-1>::template Page>
