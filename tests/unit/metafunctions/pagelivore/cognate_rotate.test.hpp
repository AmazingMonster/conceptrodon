...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_ROTATE_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_ROTATE_H

#include "conceptrodon/metafunctions/pagelivore/cognate_rotate.hpp"
