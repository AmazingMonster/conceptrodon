...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_INJECT_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_INJECT_H

#include "conceptrodon/metafunctions/pagelivore/cognate_inject.hpp"
