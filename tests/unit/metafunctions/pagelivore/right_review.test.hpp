...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_RIGHT_REVIEW_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_RIGHT_REVIEW_H

#include <concepts>

#include "conceptrodon/metafunctions/pagelivore/right_review.hpp"
