...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_TERSE_RIGHT_INTERVIEW_2ND_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_TERSE_RIGHT_INTERVIEW_2ND_H
...
namespace UnitTests {
namespace TestTerseRightInterview2nd {
...
::Page<I>::template Page_v<SHEEP_SPROUT(120, *(-1))>;
