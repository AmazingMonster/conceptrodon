...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_INDEPENDENT_COGNATE_LEFT_INTERVIEW_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_INDEPENDENT_COGNATE_LEFT_INTERVIEW_H

#include <concepts>
#include <type_traits>
#include "conceptrodon/shuttle.hpp"
#include "conceptrodon/pagelivore/independent_cognate_left_interview.hpp"
...
namespace UnitTests {
namespace TestIndependentCognateLeftInterview {
...
template<int I>
constexpr auto Interviewed = IndependentCognateLeftInterview<NoGreaterThanZero, EqualNegative>
::Page<nullptr, -I>::template Page_v<SHEEP_SPROUT(20)>;
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep.hpp"
template<int I>
constexpr auto FailInterviewed = IndependentCognateLeftInterview<NoGreaterThanZero, EqualNegative>
