...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_ERASE_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_ERASE_H

#include <utility>

#include "conceptrodon/metafunctions/pagelivore/cognate_erase.hpp"
