...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_TERSE_INDEPENDENT_COGNATE_RIGHT_INTERVIEW_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_TERSE_INDEPENDENT_COGNATE_RIGHT_INTERVIEW_H
...
namespace UnitTests {
namespace TestTerseIndependentCognateRightInterview {
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep.hpp"
template<int I>
constexpr auto FailInterviewed = TerseIndependentCognateRightInterview<NoGreaterThanZero, EqualNegative>
