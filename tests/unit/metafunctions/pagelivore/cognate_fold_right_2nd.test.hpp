...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_COGNATE_FOLD_RIGHT_2ND_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_COGNATE_FOLD_RIGHT_2ND_H
...
EQUAL_VALUE(CognateFoldRight<BinaryOperation>::Page<1>::Page_v<SHEEP_REVERSED_SPROUT(240)>);
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep_reversed.hpp"
EQUAL_VALUE(CognateFoldRight<BinaryOperation>::Page<1>::Page_v<SHEEP_REVERSED_SPROUT(8)>);
#include "macaron/fragmental/amenity/instances/undef_integer_sheep_reversed.hpp"
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep_reversed.hpp"
EQUAL_VALUE(CognateFoldRight<BinaryOperation>::Page<1>::Page_v<SHEEP_REVERSED_SPROUT(1)>);
#include "macaron/fragmental/amenity/instances/undef_integer_sheep_reversed.hpp"
