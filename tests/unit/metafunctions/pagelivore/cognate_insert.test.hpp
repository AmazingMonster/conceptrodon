...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_INSERT_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_COGNATE_INSERT_H

#include "conceptrodon/metafunctions/pagelivore/cognate_insert.hpp"
