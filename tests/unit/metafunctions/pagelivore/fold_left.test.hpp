...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_FOLD_LEFT_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_FOLD_LEFT_H

#include <utility>

#include "conceptrodon/metafunctions/pagelivore/fold_left.hpp"
