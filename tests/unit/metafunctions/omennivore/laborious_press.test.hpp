...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_LABORIOUS_PRESS_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_LABORIOUS_PRESS_H

#include "conceptrodon/metafunctions/omennivore/laborious_press.hpp"
