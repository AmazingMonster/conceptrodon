...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_CLASSIC_MODIFY_TYPES_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_CLASSIC_MODIFY_TYPES_H

#include <utility>

#include "conceptrodon/metafunctions/omennivore/classic_modify_types.hpp"
...
namespace UnitTests {
namespace TestClassicModifyTypes {
...
SAME_TYPE
(
    ClassicModifyTypes<std::make_index_sequence<0>, ALKANE_SPROUT(119)>
    ::Road<PlusOne>
