...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ZIP_CALM_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ZIP_CALM_H
...
template<template<template<template<template<template<typename...> class...> class...> class...> class...> class...Perseverance>
struct ArgArgVessel {};
...
SAME_TYPE(Zip<Arg_0, Arg_1>::Glow<CrossSection>::Road<Capsule>);

#define SHEEP_PREFIX \
    Zip<Arg_0, Arg_1>::Glow<CrossSection>::Page<
#define SHEEP_SUFFIX \
    >
#define SHEEP_SEPARATOR  \
    ,
