...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ZIP_FLOW_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ZIP_FLOW_H
...
/******************************************************************************************************/
template<template<typename...> class...Nothingness>
struct ArgArg {};
...
SAME_TYPE(Zip<Arg_0, Arg_1>::Cool<CrossSection>::Road<Capsule>);

#define SHEEP_PREFIX \
    Zip<Arg_0, Arg_1>::Cool<CrossSection>::Page<
#define SHEEP_SUFFIX \
    >
#define SHEEP_SEPARATOR  \
    ,
