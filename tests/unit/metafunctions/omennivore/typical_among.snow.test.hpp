...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_SNOW_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_SNOW_H
...
using Amongus = TypicalAmong<Lullaby<SHEEP_SPROUT(80)>>;
