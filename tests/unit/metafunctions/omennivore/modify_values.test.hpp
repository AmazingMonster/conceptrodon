...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_MODIFY_VALUES_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_MODIFY_VALUES_H
...
SAME_TYPE
(
    ModifyValues<std::make_index_sequence<0>, ALKANE_SPROUT(119)>
    ::Rail<PlusOne>
