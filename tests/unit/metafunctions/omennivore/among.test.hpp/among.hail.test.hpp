...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_AMONG_HAIL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_AMONG_HAIL_H
...
using Amongus = Among<Halcyon<SHEEP_SPROUT(80)>>;
