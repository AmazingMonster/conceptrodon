...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_AMONG_DAWN_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_AMONG_DAWN_H
...
using Amongus = Among<Nirvana<SHEEP_SPROUT(80)>>;
