...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_BI_HARVEST_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_BI_HARVEST_H

#include <utility>

#include "conceptrodon/metafunctions/omennivore/bi_harvest.hpp"
