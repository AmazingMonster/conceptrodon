...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_DAWN_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_DAWN_H
...
using Amongus = TypicalAmong<Nirvana<SHEEP_SPROUT(80)>>;
