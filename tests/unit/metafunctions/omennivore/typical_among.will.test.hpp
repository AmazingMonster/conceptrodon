...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_WILL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_WILL_H
...
using Amongus = TypicalAmong<Morning<SHEEP_SPROUT(80)>>;
