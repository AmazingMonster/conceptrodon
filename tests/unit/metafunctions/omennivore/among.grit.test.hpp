...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_AMONG_GRIT_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_AMONG_GRIT_H
...
using Amongus = Among<Sunrise<SHEEP_SPROUT(80)>>;
