...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_COOL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_COOL_H
...
using Amongus = TypicalAmong<Pursuit<SHEEP_SPROUT(80)>>;
