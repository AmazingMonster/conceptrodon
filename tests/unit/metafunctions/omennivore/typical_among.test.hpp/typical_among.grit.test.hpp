...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_GRIT_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_TYPICAL_AMONG_GRIT_H
...
using Amongus = TypicalAmong<Sunrise<SHEEP_SPROUT(80)>>;
