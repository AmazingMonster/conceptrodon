...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_SENSIBLE_RIGHT_INTERVIEW_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_SENSIBLE_RIGHT_INTERVIEW_H

#include <utility>

#include "conceptrodon/utilities/shuttle.hpp"
#include "conceptrodon/metafunctions/typelivore/sensible_right_interview.hpp"
...
::template Mold_v<std::integral_constant<int, I>, int>;
