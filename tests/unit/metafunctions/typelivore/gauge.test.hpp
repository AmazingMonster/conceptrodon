...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_GAUGE_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_GAUGE_H

#include <concepts>

#include "conceptrodon/metafunctions/typelivore/gauge.hpp"
