...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_KINDRED_CLASSIC_FOLD_LEFT_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_KINDRED_CLASSIC_FOLD_LEFT_H
...
SAME_TYPE
(
    KindredClassicFoldLeft<SHEEP_SPROUT(240)>
...
SAME_TYPE
(
    KindredClassicFoldLeft<SHEEP_SPROUT(8)>
    ::Mold<std::integral_constant<int, 1>>
    ::Road<BinaryOperation>
);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
