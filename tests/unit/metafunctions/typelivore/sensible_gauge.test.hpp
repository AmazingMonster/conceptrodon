...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_SENSIBLE_GAUGE_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_SENSIBLE_GAUGE_H

#include <utility>

#include "conceptrodon/metafunctions/typelivore/sensible_gauge.hpp"
