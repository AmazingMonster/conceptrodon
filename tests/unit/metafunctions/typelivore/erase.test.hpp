...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ERASE_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ERASE_H

#include <utility>

#include "conceptrodon/metafunctions/typelivore/erase.hpp"
