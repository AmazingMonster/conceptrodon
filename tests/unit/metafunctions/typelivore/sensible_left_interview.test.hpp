...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_SENSIBLE_LEFT_INTERVIEW_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_SENSIBLE_LEFT_INTERVIEW_H
...
template<int I>
constexpr auto Interviewed = SensibleLeftInterview<SHEEP_SPROUT(80)>
