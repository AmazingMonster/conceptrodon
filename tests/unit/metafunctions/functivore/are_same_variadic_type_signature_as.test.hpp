...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ARE_SAME_VARIADIC_TYPE_SIGNATURE_AS_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ARE_SAME_VARIADIC_TYPE_SIGNATURE_AS_H

#include "conceptrodon/metafunctions/functivore/are_same_variadic_type_signature_as.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAreSameVariadicTypeSignatureAs {
...
static_assert
(
    AreSameVariadicTypeSignatureAs<decltype(fun_1)>
    ::Mold
    <
        decltype(fun_2),
        decltype(FunP_1),
...
static_assert
(
    AreSameVariadicTypeSignatureAs<decltype(FunP_0)>
    ::Mold
    <
        decltype(FunP_0),
        decltype(FunAddr_0),
...
static_assert
(
    AreSameVariadicTypeSignatureAs<decltype(fun_3)>
    ::Mold
    <
        decltype(FunP_3),
        decltype(FunAddr_3),
