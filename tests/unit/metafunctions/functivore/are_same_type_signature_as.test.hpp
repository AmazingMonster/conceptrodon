...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ARE_SAME_TYPE_SIGNATURE_AS_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ARE_SAME_TYPE_SIGNATURE_AS_H

#include "conceptrodon/metafunctions/functivore/are_same_type_signature_as.hpp"
