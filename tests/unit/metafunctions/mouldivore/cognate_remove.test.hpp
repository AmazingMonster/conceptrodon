...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_REMOVE_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_REMOVE_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/cognate_remove.hpp"
