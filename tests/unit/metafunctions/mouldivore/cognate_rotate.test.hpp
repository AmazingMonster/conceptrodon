...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_ROTATE_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_ROTATE_H

#include "conceptrodon/metafunctions/mouldivore/cognate_rotate.hpp"
