...
#ifndef CONCEPTRODON_TESTS_UNIT_MOULDIVORE_ALTER_H
#define CONCEPTRODON_TESTS_UNIT_MOULDIVORE_ALTER_H
...
SAME_TYPE(Alter<Tester>::Road<PlusOne>::Page<SHEEP_SPROUT(120, *2)>::Mold<LLAMA_SPROUT(240)>);
