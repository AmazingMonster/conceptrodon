...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FLIP_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FLIP_H
...
VALID(Flip<Tester>::Road<Capsule>::Mold<>::value);
VALID(Flip<Tester>::Rail<Shuttle>::Mold<>::value);
VALID(Flip<Tester>::Flow<Vehicle>::Mold<>::value);
VALID(Flip<Tester>::Sail<Carrier>::Mold<>::value);
VALID(Flip<Tester>::Snow<Reverie>::Mold<>::value);
VALID(Flip<Tester>::Hail<Phantom>::Mold<>::value);
VALID(Flip<Tester>::Cool<Forlorn>::Mold<>::value);
VALID(Flip<Tester>::Calm<Travail>::Mold<>::value);
VALID(Flip<Tester>::Grit<Lullaby>::Mold<>::value);
VALID(Flip<Tester>::Will<Halcyon>::Mold<>::value);
VALID(Flip<Tester>::Glow<Pursuit>::Mold<>::value);
VALID(Flip<Tester>::Dawn<Persist>::Mold<>::value);
/******************************************************************************************************/
