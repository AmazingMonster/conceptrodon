...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_SLICE_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_SLICE_H

#include "conceptrodon/metafunctions/mouldivore/cognate_slice.hpp"
