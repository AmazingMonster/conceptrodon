...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_PLUME_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_PLUME_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/bi_cognate_plume.hpp"
...
SAME_TYPE(BiCognatePlume<Operation>::Road<SHEEP_SPROUT(240)>::Mold<LLAMA_SPROUT(240)>);
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_llama.hpp"
SAME_TYPE(BiCognatePlume<Operation>::Road<Dummy<1>::Mold>::Mold<LLAMA_SPROUT(240)>);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_llama.hpp"
...
SAME_TYPE(BiCognatePlume<Operation>::Road<SHEEP_SPROUT(240)>::Mold<std::integral_constant<int, 1>>);
...
SAME_TYPE(BiCognatePlume<Operation>::Rail<SHEEP_SPROUT(240)>::Page<LLAMA_SPROUT(240)>);
...
#include "macaron/fragmental/amenity/instances/define_integer_llama.hpp"
SAME_TYPE(BiCognatePlume<Operation>::Rail<Dummy<1>::Page>::Page<LLAMA_SPROUT(240)>);
#include "macaron/fragmental/amenity/instances/undef_integer_llama.hpp"
...
SAME_TYPE(BiCognatePlume<Operation>::Rail<SHEEP_SPROUT(240)>::Page<1>);
