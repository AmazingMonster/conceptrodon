...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_ERASE_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_ERASE_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/cognate_erase.hpp"
