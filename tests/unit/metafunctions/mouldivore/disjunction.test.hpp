...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_DISJUNCTION_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_DISJUNCTION_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/disjunction.hpp"
