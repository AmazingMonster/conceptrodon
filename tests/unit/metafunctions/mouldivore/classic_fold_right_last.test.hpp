...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_CLASSIC_FOLD_RIGHT_LAST_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_CLASSIC_FOLD_RIGHT_LAST_H

#include <concepts>

#include "conceptrodon/metafunctions/mouldivore/classic_fold_right_last.hpp"
