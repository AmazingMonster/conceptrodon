...
SAME_TYPE(FoldLeftFirst<BinaryOperation>::Mold<std::integral_constant<int, 1>, SHEEP_SPROUT(240)>);
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
SAME_TYPE(FoldLeftFirst<BinaryOperation>::Mold<std::integral_constant<int, 1>, SHEEP_SPROUT(8)>);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
SAME_TYPE(FoldLeftFirst<BinaryOperation>::Mold<std::integral_constant<int, 1>, SHEEP_SPROUT(1)>);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
