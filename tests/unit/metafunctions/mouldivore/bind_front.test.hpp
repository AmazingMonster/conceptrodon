...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_BIND_FRONT_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_BIND_FRONT_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/bind_front.hpp"
