...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FOLD_RIGHT_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FOLD_RIGHT_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/fold_right.hpp"
