...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_CLASSIC_TRANSFORM_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_COGNATE_CLASSIC_TRANSFORM_H
...
SAME_TYPE
(
    CognateClassicTransform<Operation>
