...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FOLD_LEFT_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FOLD_LEFT_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/fold_left.hpp"
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
SAME_TYPE(FoldLeft<BinaryOperation_t>::Mold<std::integral_constant<int, 1>>::Mold<SHEEP_SPROUT(8)>);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
