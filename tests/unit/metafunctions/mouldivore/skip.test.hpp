...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_SKIP_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_SKIP_H

#include <utility>

#include "conceptrodon/metafunctions/mouldivore/skip.hpp"
...
VALID(Skip<Tester>::Mold<>::Page<>::Road<>::Rail<>::Flow<>::Sail<>::Snow<>::Hail<>::Cool<>::Calm<>::Grit<>::Will<>::Glow<>::Dawn<>::Commit::Mold<>::value);
VALID(Skip<Tester>::Mold<>::Mold<std::true_type>::Commit::Mold<>::value);
VALID(Skip<Tester>::Page<true>::Commit::Mold<void>::value);
