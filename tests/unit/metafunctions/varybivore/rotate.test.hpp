...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ROTATE_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ROTATE_H

#include "conceptrodon/metafunctions/varybivore/rotate.hpp"
