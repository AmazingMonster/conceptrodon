...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_SENSIBLE_PLUME_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_SENSIBLE_PLUME_H

#include <utility>

#include "conceptrodon/metafunctions/varybivore/sensible_plume.hpp"
...
SAME_TYPE(SensiblePlume<LLAMA_SPROUT(240)>::Road<Operation>::Rail<SHEEP_SPROUT(240)>);
...
#include "macaron/fragmental/amenity/instances/define_integer_llama.hpp"
SAME_TYPE(SensiblePlume<LLAMA_SPROUT(240)>::Road<Operation>::Rail<Dummy<1>::Page>);
#include "macaron/fragmental/amenity/instances/undef_integer_llama.hpp"
...
SAME_TYPE(SensiblePlume<1>::Road<Operation>::Rail<SHEEP_SPROUT(240)>);
