...
#ifndef CONCEPTRODON_TESTS_UNIT_VARYBIVORE_RIGHT_INTERVIEW_H
#define CONCEPTRODON_TESTS_UNIT_VARYBIVORE_RIGHT_INTERVIEW_H
...
template<int I>
constexpr auto Interviewed = RightInterview<SHEEP_SPROUT(120, *(-1))>
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep.hpp"
template<int I>
constexpr auto FailInterviewed = RightInterview<SHEEP_SPROUT(40), I>
