...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_CLASSIC_PLUME_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_CLASSIC_PLUME_H
...
SAME_TYPE(ClassicPlume<LLAMA_SPROUT(240)>::Rail<SHEEP_SPROUT(240)>::Road<Operation>);
SAME_TYPE(ClassicPlume<LLAMA_SPROUT(240)>::Rail<SHEEP_SPROUT(240)>::UniRoad<Operation>);
...
#include "macaron/fragmental/amenity/instances/define_integer_llama.hpp"
SAME_TYPE(ClassicPlume<LLAMA_SPROUT(240)>::Rail<Dummy<1>::Page>::Road<Operation>);
SAME_TYPE(ClassicPlume<LLAMA_SPROUT(240)>::Rail<Dummy<1>::Page>::UniRoad<Operation>);
#include "macaron/fragmental/amenity/instances/undef_integer_llama.hpp"
...
SAME_TYPE(ClassicPlume<1>::Rail<SHEEP_SPROUT(240)>::Road<Operation>);
SAME_TYPE(ClassicPlume<1>::Rail<SHEEP_SPROUT(240)>::UniRoad<Operation>);
