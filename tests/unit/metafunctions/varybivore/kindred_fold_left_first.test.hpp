...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_KINDRED_FOLD_LEFT_FIRST_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_KINDRED_FOLD_LEFT_FIRST_H

#include <concepts>
#include <type_traits>
#include "conceptrodon/metafunctions/varybivore/kindred_fold_left_first.hpp"
