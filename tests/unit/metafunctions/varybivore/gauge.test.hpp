...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_GAUGE_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_GAUGE_H

#include <utility>

#include "conceptrodon/metafunctions/varybivore/gauge.hpp"
