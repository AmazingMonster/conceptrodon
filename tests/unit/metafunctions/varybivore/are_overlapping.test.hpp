...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ARE_OVERLAPPING_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ARE_OVERLAPPING_H

#include "conceptrodon/metafunctions/varybivore/are_overlapping.hpp"
