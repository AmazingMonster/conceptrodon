...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_OBSERVE_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_OBSERVE_H

#include "conceptrodon/metafunctions/varybivore/observe.hpp"
