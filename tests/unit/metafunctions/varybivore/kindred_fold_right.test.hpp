...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_KINDRED_FOLD_RIGHT_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_KINDRED_FOLD_RIGHT_H

#include <utility>

#include "conceptrodon/metafunctions/varybivore/kindred_fold_right.hpp"
