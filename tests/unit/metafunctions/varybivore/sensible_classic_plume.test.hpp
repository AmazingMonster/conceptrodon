...
SAME_TYPE(SensibleClassicPlume<LLAMA_SPROUT(240)>::Road<Capsule>::Rail<SHEEP_SPROUT(240)>);
...
#include "macaron/fragmental/amenity/instances/define_integer_llama.hpp"
SAME_TYPE(SensibleClassicPlume<LLAMA_SPROUT(240)>::Road<Capsule>::Rail<Dummy<1>::Page>);
#include "macaron/fragmental/amenity/instances/undef_integer_llama.hpp"
...
SAME_TYPE(SensibleClassicPlume<1>::Road<Capsule>::Rail<SHEEP_SPROUT(240)>);
