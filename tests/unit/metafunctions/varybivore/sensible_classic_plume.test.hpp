...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_SENSIBLE_CLASSIC_PLUME_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_SENSIBLE_CLASSIC_PLUME_H

#include <utility>

#include "conceptrodon/metafunctions/varybivore/sensible_classic_plume.hpp"
