...
#ifndef CONCEPTRODON_TESTS_UNIT_VARYBIVORE_FOLD_RIGHT_2ND_H
#define CONCEPTRODON_TESTS_UNIT_VARYBIVORE_FOLD_RIGHT_2ND_H
...
EQUAL_VALUE(FoldRight<SHEEP_REVERSED_SPROUT(240)>::Page<1>::Rail_v<BinaryOperation>);
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep_reversed.hpp"
EQUAL_VALUE(FoldRight<SHEEP_REVERSED_SPROUT(8)>::Page<1>::Rail_v<BinaryOperation>);
#include "macaron/fragmental/amenity/instances/undef_integer_sheep_reversed.hpp"
...
#include "macaron/fragmental/amenity/instances/define_integer_sheep_reversed.hpp"
EQUAL_VALUE(FoldRight<SHEEP_REVERSED_SPROUT(1)>::Page<1>::Rail<BinaryOperation>::value);
#include "macaron/fragmental/amenity/instances/undef_integer_sheep_reversed.hpp"
