...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_PAGELESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_PAGELESS_H
...
/******************************************************************************************************/
static_assert(AllPageless<WorkingClass, WorkingClass>);
static_assert(AllPageless<PseudoOwner, WorkingClass>);
static_assert(! AllPageless<PageOwner, PageProprietor>);
static_assert(! AllPageless<PageOwner, PageProprietor, WorkingClass>);
/******************************************************************************************************/
