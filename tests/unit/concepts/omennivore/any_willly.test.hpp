...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_WILLLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_WILLLY_H

#include "conceptrodon/omennivore/concepts/descend/all_willly.hpp"
#include "conceptrodon/omennivore/concepts/descend/descend/any_willly.hpp"

namespace Conceptrodon {
namespace Omennivore {
namespace UnitTests {
namespace TestAnyWillly {
...
/******************************************************************************************************/
static_assert(! AnyWillly<WorkingClass, WorkingClass>);
static_assert(! AnyWillly<PseudoOwner, WorkingClass>);
static_assert(AnyWillly<WillOwner, WillProprietor>);
static_assert(AnyWillly<WillOwner, WillProprietor, WorkingClass>);
/******************************************************************************************************/
...
static_assert(Tester<WillOwner, WillProprietor>::value == 2);
/******************************************************************************************************/
