...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_PAGELY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_PAGELY_H
...
/******************************************************************************************************/
static_assert(!AllPagely<WorkingClass, WorkingClass>);
static_assert(!AllPagely<PseudoOwner, WorkingClass>);
static_assert(AllPagely<PageOwner, PageProprietor>);
static_assert(! AllPagely<PageOwner, PageProprietor, WorkingClass>);
/******************************************************************************************************/
