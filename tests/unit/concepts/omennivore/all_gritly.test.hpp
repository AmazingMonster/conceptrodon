...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GRITLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GRITLY_H
...
/******************************************************************************************************/
static_assert(! AllGritly<WorkingClass, WorkingClass>);
static_assert(! AllGritly<PseudoOwner, WorkingClass>);
static_assert(AllGritly<GritOwner, GritProprietor>);
static_assert(! AllGritly<GritOwner, GritProprietor, WorkingClass>);
/******************************************************************************************************/
