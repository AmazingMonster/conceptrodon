...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_HAILLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_HAILLESS_H
...
/******************************************************************************************************/
static_assert(AllHailless<WorkingClass, WorkingClass>);
static_assert(AllHailless<PseudoOwner, WorkingClass>);
static_assert(! AllHailless<HailOwner, HailProprietor>);
static_assert(! AllHailless<HailOwner, HailProprietor, WorkingClass>);
/******************************************************************************************************/
