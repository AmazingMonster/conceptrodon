...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_MOLDLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_MOLDLY_H
...
/******************************************************************************************************/
static_assert(!AllMoldly<WorkingClass, WorkingClass>);
static_assert(!AllMoldly<PseudoOwner, WorkingClass>);
static_assert(AllMoldly<MoldOwner, MoldProprietor>);
static_assert(! AllMoldly<MoldOwner, MoldProprietor, WorkingClass>);
/******************************************************************************************************/
