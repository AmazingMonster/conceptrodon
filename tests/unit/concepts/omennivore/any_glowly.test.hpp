...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_GLOWLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_GLOWLY_H

#include "conceptrodon/omennivore/concepts/descend/all_glowly.hpp"
#include "conceptrodon/omennivore/concepts/descend/descend/any_glowly.hpp"

namespace Conceptrodon {
namespace Omennivore {
namespace UnitTests {
namespace TestAnyGlowly {
...
/******************************************************************************************************/
static_assert(! AnyGlowly<WorkingClass, WorkingClass>);
static_assert(! AnyGlowly<PseudoOwner, WorkingClass>);
static_assert(AnyGlowly<GlowOwner, GlowProprietor>);
static_assert(AnyGlowly<GlowOwner, GlowProprietor, WorkingClass>);
/******************************************************************************************************/
...
static_assert(Tester<GlowOwner, GlowProprietor>::value == 2);
/******************************************************************************************************/
