...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SAILLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SAILLY_H
...
/******************************************************************************************************/
static_assert(! AllSailly<WorkingClass, WorkingClass>);
static_assert(! AllSailly<PseudoOwner, WorkingClass>);
static_assert(AllSailly<SailOwner, SailProprietor>);
static_assert(! AllSailly<SailOwner, SailProprietor, WorkingClass>);
/******************************************************************************************************/
