...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_DAWNLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_DAWNLESS_H
...
/******************************************************************************************************/
static_assert(AllDawnless<WorkingClass, WorkingClass>);
static_assert(AllDawnless<PseudoOwner, WorkingClass>);
static_assert(! AllDawnless<DawnOwner, DawnProprietor>);
static_assert(! AllDawnless<DawnOwner, DawnProprietor, WorkingClass>);
/******************************************************************************************************/
