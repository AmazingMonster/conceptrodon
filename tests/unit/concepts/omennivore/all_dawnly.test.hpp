...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_DAWNLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_DAWNLY_H
...
/******************************************************************************************************/
static_assert(! AllDawnly<WorkingClass, WorkingClass>);
static_assert(! AllDawnly<PseudoOwner, WorkingClass>);
static_assert(AllDawnly<DawnOwner, DawnProprietor>);
static_assert(! AllDawnly<DawnOwner, DawnProprietor, WorkingClass>);
/******************************************************************************************************/
