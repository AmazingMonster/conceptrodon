...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GRITLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GRITLESS_H
...
/******************************************************************************************************/
static_assert(AllGritless<WorkingClass, WorkingClass>);
static_assert(AllGritless<PseudoOwner, WorkingClass>);
static_assert(! AllGritless<GritOwner, GritProprietor>);
static_assert(! AllGritless<GritOwner, GritProprietor, WorkingClass>);
/******************************************************************************************************/
