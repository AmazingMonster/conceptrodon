...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_GLOWFUL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_GLOWFUL_H

#include "conceptrodon/concepts/omennivore/all_glowful.hpp"
