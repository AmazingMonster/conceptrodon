...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_RAILLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_RAILLY_H
...
/******************************************************************************************************/
static_assert(! AllRailly<WorkingClass, WorkingClass>);
static_assert(! AllRailly<PseudoOwner, WorkingClass>);
static_assert(AllRailly<RailOwner, RailProprietor>);
static_assert(! AllRailly<RailOwner, RailProprietor, WorkingClass>);
/******************************************************************************************************/
