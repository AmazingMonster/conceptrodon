...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_WILLLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_WILLLY_H
...
/******************************************************************************************************/
static_assert(! AllWillly<WorkingClass, WorkingClass>);
static_assert(! AllWillly<PseudoOwner, WorkingClass>);
static_assert(AllWillly<WillOwner, WillProprietor>);
static_assert(! AllWillly<WillOwner, WillProprietor, WorkingClass>);
/******************************************************************************************************/
