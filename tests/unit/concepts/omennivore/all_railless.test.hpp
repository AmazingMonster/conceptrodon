...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_RAILLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_RAILLESS_H
...
/******************************************************************************************************/
static_assert(AllRailless<WorkingClass, WorkingClass>);
static_assert(AllRailless<PseudoOwner, WorkingClass>);
static_assert(! AllRailless<RailOwner, RailProprietor>);
static_assert(! AllRailless<RailOwner, RailProprietor, WorkingClass>);
/******************************************************************************************************/
