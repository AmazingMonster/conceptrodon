...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_MOLDLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_MOLDLESS_H
...
/******************************************************************************************************/
static_assert(AllMoldless<WorkingClass, WorkingClass>);
static_assert(AllMoldless<PseudoOwner, WorkingClass>);
static_assert(! AllMoldless<MoldOwner, MoldProprietor>);
static_assert(! AllMoldless<MoldOwner, MoldProprietor, WorkingClass>);
/******************************************************************************************************/
