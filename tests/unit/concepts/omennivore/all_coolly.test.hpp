...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_COOLLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_COOLLY_H
...
/******************************************************************************************************/
static_assert(! AllCoolly<WorkingClass, WorkingClass>);
static_assert(! AllCoolly<PseudoOwner, WorkingClass>);
static_assert(AllCoolly<CoolOwner, CoolProprietor>);
static_assert(! AllCoolly<CoolOwner, CoolProprietor, WorkingClass>);
/******************************************************************************************************/
