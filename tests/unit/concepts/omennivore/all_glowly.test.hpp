...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GLOWLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GLOWLY_H
...
/******************************************************************************************************/
static_assert(! AllGlowly<WorkingClass, WorkingClass>);
static_assert(! AllGlowly<PseudoOwner, WorkingClass>);
static_assert(AllGlowly<GlowOwner, GlowProprietor>);
static_assert(! AllGlowly<GlowOwner, GlowProprietor, WorkingClass>);
/******************************************************************************************************/
