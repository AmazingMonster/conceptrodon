...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_UNPEGFUL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_UNPEGFUL_H
...
/******************************************************************************************************/
template<typename...Args>
requires AllUnpegful<Args...> && Mouldivore::AllFailed<Pagelivore::IsSpecializationOf<Peg>::ProtoMold, Args...>
struct Tester<Args...>
{
