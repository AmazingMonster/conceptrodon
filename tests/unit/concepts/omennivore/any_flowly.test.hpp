...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_FLOWLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_FLOWLY_H

#include "conceptrodon/omennivore/concepts/descend/all_flowly.hpp"
#include "conceptrodon/omennivore/concepts/descend/descend/any_flowly.hpp"

namespace Conceptrodon {
namespace Omennivore {
namespace UnitTests {
namespace TestAnyFlowly {
...
/******************************************************************************************************/
static_assert(! AnyFlowly<WorkingClass, WorkingClass>);
static_assert(! AnyFlowly<PseudoOwner, WorkingClass>);
static_assert(AnyFlowly<FlowOwner, FlowProprietor>);
static_assert(AnyFlowly<FlowOwner, FlowProprietor, WorkingClass>);
/******************************************************************************************************/
...
static_assert(Tester<FlowOwner, FlowProprietor>::value == 2);
/******************************************************************************************************/
