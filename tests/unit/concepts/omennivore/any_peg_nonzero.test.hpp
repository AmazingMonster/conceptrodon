...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_PEG_NONZERO_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_PEG_NONZERO_H

#include "conceptrodon/concepts/omennivore/any_peg_nonzero.hpp"
