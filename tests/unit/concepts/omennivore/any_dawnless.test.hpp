...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_DAWNLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_DAWNLESS_H

#include "conceptrodon/omennivore/concepts/descend/all_dawnless.hpp"
#include "conceptrodon/omennivore/concepts/descend/descend/any_dawnless.hpp"

namespace Conceptrodon {
namespace Omennivore {
namespace UnitTests {
namespace TestAnyDawnless {
...
/******************************************************************************************************/
static_assert(AnyDawnless<WorkingClass, WorkingClass>);
static_assert(AnyDawnless<PseudoOwner, WorkingClass>);
static_assert(! AnyDawnless<DawnOwner, DawnProprietor>);
static_assert(AnyDawnless<DawnOwner, DawnProprietor, WorkingClass>);
/******************************************************************************************************/
...
static_assert(Tester<DawnOwner, DawnProprietor>::value == 0);
