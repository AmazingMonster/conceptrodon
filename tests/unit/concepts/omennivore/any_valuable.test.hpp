...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_VALUABLE_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_VALUABLE_H

#include "conceptrodon/concepts/omennivore/any_valuable.hpp"
