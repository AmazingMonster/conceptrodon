...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_UNVALUABLE_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_UNVALUABLE_H

#include "conceptrodon/concepts/omennivore//any_unvaluable.hpp"
