...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SNOWLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SNOWLY_H
...
/******************************************************************************************************/
static_assert(! AllSnowly<WorkingClass, WorkingClass>);
static_assert(! AllSnowly<PseudoOwner, WorkingClass>);
static_assert(AllSnowly<SnowOwner, SnowProprietor>);
static_assert(! AllSnowly<SnowOwner, SnowProprietor, WorkingClass>);
/******************************************************************************************************/
