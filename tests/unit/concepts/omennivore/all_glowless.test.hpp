...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GLOWLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_GLOWLESS_H
...
/******************************************************************************************************/
static_assert(AllGlowless<WorkingClass, WorkingClass>);
static_assert(AllGlowless<PseudoOwner, WorkingClass>);
static_assert(! AllGlowless<GlowOwner, GlowProprietor>);
static_assert(! AllGlowless<GlowOwner, GlowProprietor, WorkingClass>);
/******************************************************************************************************/
