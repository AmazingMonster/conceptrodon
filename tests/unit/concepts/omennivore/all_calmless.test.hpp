...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_CALMLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_CALMLESS_H
...
/******************************************************************************************************/
static_assert(AllCalmless<WorkingClass, WorkingClass>);
static_assert(AllCalmless<PseudoOwner, WorkingClass>);
static_assert(! AllCalmless<CalmOwner, CalmProprietor>);
static_assert(! AllCalmless<CalmOwner, CalmProprietor, WorkingClass>);
/******************************************************************************************************/
