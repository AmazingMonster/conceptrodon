...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_UNTYPICAL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_UNTYPICAL_H

#include "conceptrodon/concepts/omennivore/any_untypical.hpp"
