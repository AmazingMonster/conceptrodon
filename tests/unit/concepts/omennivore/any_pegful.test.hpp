...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_PEGFUL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ANY_PEGFUL_H

#include "conceptrodon/concepts/omennivore/any_pegful.hpp"
