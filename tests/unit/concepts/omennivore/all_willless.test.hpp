...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_WILLLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_WILLLESS_H
...
/******************************************************************************************************/
static_assert(AllWillless<WorkingClass, WorkingClass>);
static_assert(AllWillless<PseudoOwner, WorkingClass>);
static_assert(! AllWillless<WillOwner, WillProprietor>);
static_assert(! AllWillless<WillOwner, WillProprietor, WorkingClass>);
/******************************************************************************************************/
