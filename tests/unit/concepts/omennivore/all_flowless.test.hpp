...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_FLOWLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_FLOWLESS_H
...
/******************************************************************************************************/
static_assert(AllFlowless<WorkingClass, WorkingClass>);
static_assert(AllFlowless<PseudoOwner, WorkingClass>);
static_assert(! AllFlowless<FlowOwner, FlowProprietor>);
static_assert(! AllFlowless<FlowOwner, FlowProprietor, WorkingClass>);
/******************************************************************************************************/
