...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_UNHAILFUL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_UNHAILFUL_H

#include "conceptrodon/concepts/omennivore/unhailful.hpp"
