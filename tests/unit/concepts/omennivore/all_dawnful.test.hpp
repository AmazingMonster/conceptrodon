...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_DAWNFUL_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_DAWNFUL_H

#include "conceptrodon/concepts/omennivore/all_dawnful.hpp"
