...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SAILLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SAILLESS_H
...
/******************************************************************************************************/
static_assert(AllSailless<WorkingClass, WorkingClass>);
static_assert(AllSailless<PseudoOwner, WorkingClass>);
static_assert(! AllSailless<SailOwner, SailProprietor>);
static_assert(! AllSailless<SailOwner, SailProprietor, WorkingClass>);
/******************************************************************************************************/
