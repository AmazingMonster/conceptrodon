...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_GRITLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ANY_GRITLY_H

#include "conceptrodon/omennivore/concepts/descend/all_gritly.hpp"
#include "conceptrodon/omennivore/concepts/descend/descend/any_gritly.hpp"

namespace Conceptrodon {
namespace Omennivore {
namespace UnitTests {
namespace TestAnyGritly {
...
/******************************************************************************************************/
static_assert(! AnyGritly<WorkingClass, WorkingClass>);
static_assert(! AnyGritly<PseudoOwner, WorkingClass>);
static_assert(AnyGritly<GritOwner, GritProprietor>);
static_assert(AnyGritly<GritOwner, GritProprietor, WorkingClass>);
/******************************************************************************************************/
...
static_assert(Tester<GritOwner, GritProprietor>::value == 2);
/******************************************************************************************************/
