...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_PEG_ZERO_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_PEG_ZERO_H

#include "conceptrodon/concepts/omennivore/all_peg_zero.hpp"
#include "conceptrodon/concepts/typelivore/all_zero.hpp"
