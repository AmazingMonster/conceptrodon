...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_ROADLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_ROADLY_H
...
/******************************************************************************************************/
static_assert(!AllRoadly<WorkingClass, WorkingClass>);
static_assert(!AllRoadly<PseudoOwner, WorkingClass>);
static_assert(AllRoadly<RoadOwner, RoadProprietor>);
static_assert(! AllRoadly<RoadOwner, RoadProprietor, WorkingClass>);
/******************************************************************************************************/
