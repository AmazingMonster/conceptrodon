...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_ROADLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_ROADLESS_H
...
/******************************************************************************************************/
static_assert(AllRoadless<WorkingClass, WorkingClass>);
static_assert(AllRoadless<PseudoOwner, WorkingClass>);
static_assert(! AllRoadless<RoadOwner, RoadProprietor>);
static_assert(! AllRoadless<RoadOwner, RoadProprietor, WorkingClass>);
/******************************************************************************************************/
