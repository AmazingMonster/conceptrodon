...
#ifndef CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_PEG_NONZERO_H
#define CONCEPTRODON_OMENNIVORE_UNIT_TESTS_TEST_ALL_PEG_NONZERO_H

#include "conceptrodon/concepts/omennivore/all_peg_nonzero.hpp"
...
static_assert(Tester<Vay<1>, Peg<1>>::value == 2);
