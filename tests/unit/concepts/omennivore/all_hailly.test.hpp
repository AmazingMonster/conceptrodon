...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_HAILLY_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_HAILLY_H
...
/******************************************************************************************************/
static_assert(! AllHailly<WorkingClass, WorkingClass>);
static_assert(! AllHailly<PseudoOwner, WorkingClass>);
static_assert(AllHailly<HailOwner, HailProprietor>);
static_assert(! AllHailly<HailOwner, HailProprietor, WorkingClass>);
/******************************************************************************************************/
