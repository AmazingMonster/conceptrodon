...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_COOLLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_COOLLESS_H
...
/******************************************************************************************************/
static_assert(AllCoolless<WorkingClass, WorkingClass>);
static_assert(AllCoolless<PseudoOwner, WorkingClass>);
static_assert(! AllCoolless<CoolOwner, CoolProprietor>);
static_assert(! AllCoolless<CoolOwner, CoolProprietor, WorkingClass>);
/******************************************************************************************************/
