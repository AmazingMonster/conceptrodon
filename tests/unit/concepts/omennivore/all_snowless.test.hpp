...
#ifndef CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SNOWLESS_H
#define CONCEPTRODON_TESTS_UNIT_OMENNIVORE_ALL_SNOWLESS_H
...
/******************************************************************************************************/
static_assert(AllSnowless<WorkingClass, WorkingClass>);
static_assert(AllSnowless<PseudoOwner, WorkingClass>);
static_assert(! AllSnowless<SnowOwner, SnowProprietor>);
static_assert(! AllSnowless<SnowOwner, SnowProprietor, WorkingClass>);
/******************************************************************************************************/
