...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ALL_FAILED_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ALL_FAILED_H
...
/******************************************************************************************************/
static_assert(AllFailed<AreNoGreaterThan<0>::Mold, Vay<1>, Vay<2>, Vay<3>>);
static_assert(! AllFailed<AreNoGreaterThan<0>::Mold, Vay<0>, Vay<2>, Vay<3>>);
/******************************************************************************************************/
...
template<auto...Args>
requires AllFailed<AreNoGreaterThan<0>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllFailed<AreNoGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllFailed<AreNoGreaterThan<0>::Mold, Vay<Args>...>
&& AllFailed<AreNoGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllFailed<AreNoGreaterThan<2>::Mold, Vay<Args>...>;
