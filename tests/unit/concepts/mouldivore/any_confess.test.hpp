...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ANY_CONFESS_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ANY_CONFESS_H

#include "conceptrodon/concepts/mouldivore/any_confess.hpp"
