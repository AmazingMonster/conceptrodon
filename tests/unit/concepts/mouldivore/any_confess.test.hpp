...
/******************************************************************************************************/
static_assert(AnyConfess<AreGreaterThan<0>::Mold, Monotony<1>, Monotony<2>, Monotony<3>>);
static_assert(AnyConfess<AreGreaterThan<0>::Mold, Monotony<1>, Monotony<-2>, Monotony<-3>>);
static_assert(! AnyConfess<AreGreaterThan<0>::Mold, Monotony<0>, Monotony<-1>, Monotony<-2>>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyConfess<AreGreaterThan<0>::Mold, Monotony<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyConfess<AreGreaterThan<1>::Mold, Monotony<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyConfess<AreGreaterThan<0>::Mold, Monotony<Args>...>
&& AnyConfess<AreGreaterThan<1>::Mold, Monotony<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyConfess<AreGreaterThan<2>::Mold, Monotony<Args>...>;
