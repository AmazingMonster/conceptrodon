...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ALL_CONFESS_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ALL_CONFESS_H
...
/******************************************************************************************************/
static_assert(AllConfess<AreGreaterThan<0>::Mold, Vay<1>, Vay<2>, Vay<3>>);
static_assert(! AllConfess<AreGreaterThan<0>::Mold, Vay<0>, Vay<2>, Vay<3>>);
/******************************************************************************************************/
...
template<auto...Args>
requires AllConfess<AreGreaterThan<0>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllConfess<AreGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllConfess<AreGreaterThan<0>::Mold, Vay<Args>...>
&& AllConfess<AreGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllConfess<AreGreaterThan<2>::Mold, Vay<Args>...>;
