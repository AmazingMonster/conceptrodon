...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ANY_FAILED_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ANY_FAILED_H

#include "conceptrodon/utilities/vay.hpp"
#include "conceptrodon/concepts/mouldivore/any_failed.hpp"
...
/******************************************************************************************************/
static_assert(AnyFailed<AreNoGreaterThan<0>::Mold, Vay<1>, Vay<2>, Vay<3>>);
static_assert(AnyFailed<AreNoGreaterThan<0>::Mold, Vay<1>, Vay<-2>, Vay<-3>>);
static_assert(! AnyFailed<AreNoGreaterThan<0>::Mold, Vay<0>, Vay<-1>, Vay<-2>>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyFailed<AreNoGreaterThan<0>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFailed<AreNoGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFailed<AreNoGreaterThan<0>::Mold, Vay<Args>...>
&& AnyFailed<AreNoGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyFailed<AreNoGreaterThan<2>::Mold, Vay<Args>...>;
