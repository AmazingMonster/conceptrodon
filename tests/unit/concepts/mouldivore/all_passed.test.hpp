...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ALL_PASSED_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_ALL_PASSED_H
...
/******************************************************************************************************/
static_assert(AllPassed<AreGreaterThan<0>::Mold, Vay<1>, Vay<2>, Vay<3>>);
static_assert(! AllPassed<AreGreaterThan<0>::Mold, Vay<0>, Vay<2>, Vay<3>>);
/******************************************************************************************************/
...
template<auto...Args>
requires AllPassed<AreGreaterThan<0>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllPassed<AreGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllPassed<AreGreaterThan<0>::Mold, Vay<Args>...>
&& AllPassed<AreGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllPassed<AreGreaterThan<2>::Mold, Vay<Args>...>;
