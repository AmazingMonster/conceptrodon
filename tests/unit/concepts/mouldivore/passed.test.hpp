...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_PASSED_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_PASSED_H
...
template<auto...Args>
requires Passed<AreGreaterThan<0>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Passed<AreGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Passed<AreGreaterThan<0>::Mold, Vay<Args>...>
&& Passed<AreGreaterThan<1>::Mold, Vay<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= Passed<AreGreaterThan<2>::Mold, Vay<Args>...>;
