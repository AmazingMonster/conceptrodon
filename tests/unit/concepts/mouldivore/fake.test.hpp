...
#ifndef CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FAKE_H
#define CONCEPTRODON_MOULDVORE_UNIT_TESTS_TEST_FAKE_H

#include "conceptrodon/concepts/mouldivore/fake.hpp"
