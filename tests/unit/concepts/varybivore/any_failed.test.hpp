...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_FAILED_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_FAILED_H

#include "conceptrodon/concepts/varybivore/any_failed.hpp"
...
/******************************************************************************************************/
static_assert(AnyFailed<are_no_greater_than<0>, 1, 2, 3>);
static_assert(AnyFailed<are_no_greater_than<0>, 1, -2, -3>);
static_assert(! AnyFailed<are_no_greater_than<0>, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyFailed<are_no_greater_than<0>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFailed<are_no_greater_than<1>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFailed<are_no_greater_than<0>, Args...>
&& AnyFailed<are_no_greater_than<1>, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyFailed<are_no_greater_than<2>, Args...>;
