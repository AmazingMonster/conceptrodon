...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_FALSIFY_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_FALSIFY_H

#include "conceptrodon/concepts/varybivore/all_falsify.hpp"
