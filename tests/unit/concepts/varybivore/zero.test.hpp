...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ZERO_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ZERO_H

#include "conceptrodon/concepts/varybivore/zero.hpp"
