...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_BOUNDED_BY_CLOSED_INTERVAL_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_BOUNDED_BY_CLOSED_INTERVAL_H

#include "conceptrodon/concepts/varybivore/bounded_by_closed_interval.hpp"
