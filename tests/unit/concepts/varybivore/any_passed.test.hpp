...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_PASSED_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_PASSED_H

#include "conceptrodon/concepts/varybivore/any_passed.hpp"
...
/******************************************************************************************************/
static_assert(AnyPassed<are_greater_than<0>, 1, 2, 3>);
static_assert(AnyPassed<are_greater_than<0>, 1, -2, -3>);
static_assert(! AnyPassed<are_greater_than<0>, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyPassed<are_greater_than<0>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyPassed<are_greater_than<1>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyPassed<are_greater_than<0>, Args...>
&& AnyPassed<are_greater_than<1>, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyPassed<are_greater_than<2>, Args...>;
