...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_CONFESS_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_CONFESS_H

#include "conceptrodon/utilities/vay.hpp"
#include "conceptrodon/concepts/varybivore/any_confess.hpp"
