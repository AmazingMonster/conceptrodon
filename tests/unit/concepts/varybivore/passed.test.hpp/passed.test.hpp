...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_PASSED_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_PASSED_H

#include "conceptrodon/concepts/varybivore/passed.hpp"
...
template<auto...Args>
requires Passed<are_greater_than<0, decltype(Args)...>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Passed<are_greater_than<1, decltype(Args)...>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Passed<are_greater_than<0, decltype(Args)...>, Args...>
&& Passed<are_greater_than<1, decltype(Args)...>, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= Passed<are_greater_than<2, decltype(Args)...>, Args...>;
