...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_CLARIFY_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ANY_CLARIFY_H

#include "conceptrodon/concepts/varybivore/any_clarify.hpp"
