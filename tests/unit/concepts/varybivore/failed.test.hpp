...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_FAILED_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_FAILED_H

#include "conceptrodon/concepts/varybivore/failed.hpp"
...
template<auto...Args>
requires Failed<are_no_greater_than<0, decltype(Args)...>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Failed<are_no_greater_than<1, decltype(Args)...>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Failed<are_no_greater_than<0, decltype(Args)...>, Args...>
&& Failed<are_no_greater_than<1, decltype(Args)...>, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= Failed<are_no_greater_than<2, decltype(Args)...>, Args...>;
