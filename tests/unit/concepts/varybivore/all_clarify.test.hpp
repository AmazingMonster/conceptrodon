...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_CLARIFY_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_CLARIFY_H

#include "conceptrodon/concepts/varybivore/all_clarify.hpp"
