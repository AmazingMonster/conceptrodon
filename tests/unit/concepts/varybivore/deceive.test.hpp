...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_DECEIVE_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_DECEIVE_H

#include "conceptrodon/utilities/vay.hpp"
#include "conceptrodon/concepts/varybivore/deceive.hpp"
