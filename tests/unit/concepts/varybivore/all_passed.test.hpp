...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_PASSED_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_PASSED_H

#include "conceptrodon/concepts/varybivore/all_passed.hpp"
...
/******************************************************************************************************/
static_assert(AllPassed<are_greater_than<0>, 1, 2, 3>);
static_assert(! AllPassed<are_greater_than<0>, 0, 2, 3>);
/******************************************************************************************************/
...
template<auto...Args>
requires AllPassed<are_greater_than<0>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllPassed<are_greater_than<1>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllPassed<are_greater_than<0>, Args...>
&& AllPassed<are_greater_than<1>, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllPassed<are_greater_than<2>, Args...>;
