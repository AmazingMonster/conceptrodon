...
#ifndef CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_CONFESS_H
#define CONCEPTRODON_VARYBIVORE_UNIT_TESTS_TEST_ALL_CONFESS_H

#include "conceptrodon/utilities/vay.hpp"
#include "conceptrodon/concepts/varybivore/all_confess.hpp"
...
/******************************************************************************************************/
static_assert(AllConfess<are_greater_than<0>, Vay<1>, Vay<2>, Vay<3>>);
static_assert(! AllConfess<are_greater_than<0>, Vay<0>, Vay<2>, Vay<3>>);
/******************************************************************************************************/
...
template<auto...Args>
requires AllConfess<are_greater_than<0>, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllConfess<are_greater_than<1>, Vay<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllConfess<are_greater_than<0>, Vay<Args>...>
&& AllConfess<are_greater_than<1>, Vay<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllConfess<are_greater_than<2>, Vay<Args>...>;
