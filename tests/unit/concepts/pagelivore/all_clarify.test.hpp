...
#include "conceptrodon/metafunctions/pagelivore/concepts/all_clarify.hpp"
...
/******************************************************************************************************/
static_assert(AllClarify<Varybivore::AreGreaterThan<0>::Page, 1, 2, 3>);
static_assert(! AllClarify<Varybivore::AreGreaterThan<0>::Page, 1, -2, -3>);
static_assert(! AllClarify<Varybivore::AreGreaterThan<0>::Page, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto...Args>
requires AllClarify<Varybivore::AreGreaterThan<0>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllClarify<Varybivore::AreGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllClarify<Varybivore::AreGreaterThan<0>::Page, Args...>
&& AllClarify<Varybivore::AreGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllClarify<Varybivore::AreGreaterThan<2>::Page, Args...>;
