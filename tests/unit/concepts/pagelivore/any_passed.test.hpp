...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ANY_PASSED_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ANY_PASSED_H

#include "conceptrodon/concepts/pagelivore/any_passed.hpp"
...
/******************************************************************************************************/
static_assert(AnyPassed<Varybivore::AreGreaterThan<0>::Page, 1, 2, 3>);
static_assert(AnyPassed<Varybivore::AreGreaterThan<0>::Page, 1, -2, -3>);
static_assert(! AnyPassed<Varybivore::AreGreaterThan<0>::Page, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyPassed<Varybivore::AreGreaterThan<0>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyPassed<Varybivore::AreGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyPassed<Varybivore::AreGreaterThan<0>::Page, Args...>
&& AnyPassed<Varybivore::AreGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyPassed<Varybivore::AreGreaterThan<2>::Page, Args...>;
