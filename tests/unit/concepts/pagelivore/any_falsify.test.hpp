...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ANY_FALSIFY_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ANY_FALSIFY_H
...
/******************************************************************************************************/
static_assert(AnyFalsify<Varybivore::AreNoGreaterThan<0>::Page, 1, 2, 3>);
static_assert(AnyFalsify<Varybivore::AreNoGreaterThan<0>::Page, 1, -2, -3>);
static_assert(! AnyFalsify<Varybivore::AreNoGreaterThan<0>::Page, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyFalsify<Varybivore::AreNoGreaterThan<0>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFalsify<Varybivore::AreNoGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFalsify<Varybivore::AreNoGreaterThan<0>::Page, Args...>
&& AnyFalsify<Varybivore::AreNoGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyFalsify<Varybivore::AreNoGreaterThan<2>::Page, Args...>;
