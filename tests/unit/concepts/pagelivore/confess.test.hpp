...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_CONFESS_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_CONFESS_H

#include "conceptrodon/concepts/pagelivore/confess.hpp"
