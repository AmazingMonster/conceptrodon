...
#ifndef CONCEPTRODON_TESTS_UNIT_PAGELIVORE_CLARIFY_H
#define CONCEPTRODON_TESTS_UNIT_PAGELIVORE_CLARIFY_H

#include "conceptrodon/metafunctions/pagelivore/concepts/clarify.hpp"
...
template<auto...Args>
requires Clarify<Varybivore::AreGreaterThan<0>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Clarify<Varybivore::AreGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Clarify<Varybivore::AreGreaterThan<0>::Page, Args...>
&& Clarify<Varybivore::AreGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= Clarify<Varybivore::AreGreaterThan<2>::Page, Args...>;
