...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ANY_FAILED_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ANY_FAILED_H

#include "conceptrodon/concepts/pagelivore/any_failed.hpp"
#include "conceptrodon/metafunctions/varybivore/are_no_greater_than.hpp"

namespace Conceptrodon {
namespace Pagelivore {
namespace UnitTests {
namespace TestAnyFailed {




/******************************************************************************************************/
static_assert(AnyFailed<Varybivore::AreNoGreaterThan<0>::Page, 1, 2, 3>);
static_assert(AnyFailed<Varybivore::AreNoGreaterThan<0>::Page, 1, -2, -3>);
static_assert(! AnyFailed<Varybivore::AreNoGreaterThan<0>::Page, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyFailed<Varybivore::AreNoGreaterThan<0>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFailed<Varybivore::AreNoGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyFailed<Varybivore::AreNoGreaterThan<0>::Page, Args...>
&& AnyFailed<Varybivore::AreNoGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyFailed<Varybivore::AreNoGreaterThan<2>::Page, Args...>;
