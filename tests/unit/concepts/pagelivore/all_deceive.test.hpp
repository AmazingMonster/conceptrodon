...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ALL_DECEIVE_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ALL_DECEIVE_H

#include "conceptrodon/utilities/vay.hpp"
#include "conceptrodon/concepts/pagelivore/all_deceive.hpp"
