...
#ifndef CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ALL_FAILED_H
#define CONCEPTRODON_PAGELIVORE_UNIT_TESTS_TEST_ALL_FAILED_H

#include "conceptrodon/concepts/pagelivore/all_failed.hpp"
...
/******************************************************************************************************/
static_assert(AllFailed<Varybivore::AreNoGreaterThan<0>::Page, 1, 2, 3>);
static_assert(! AllFailed<Varybivore::AreNoGreaterThan<0>::Page, 1, -2, -3>);
static_assert(! AllFailed<Varybivore::AreNoGreaterThan<0>::Page, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto...Args>
requires AllFailed<Varybivore::AreNoGreaterThan<0>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllFailed<Varybivore::AreNoGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AllFailed<Varybivore::AreNoGreaterThan<0>::Page, Args...>
&& AllFailed<Varybivore::AreNoGreaterThan<1>::Page, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllFailed<Varybivore::AreNoGreaterThan<2>::Page, Args...>;
