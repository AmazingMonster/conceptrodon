...
/******************************************************************************************************/
static_assert(AnyConfess<Varybivore::AreGreaterThan<0>::Page, Monotony<1>, Monotony<2>, Monotony<3>>);
static_assert(AnyConfess<Varybivore::AreGreaterThan<0>::Page, Monotony<1>, Monotony<-2>, Monotony<-3>>);
static_assert(! AnyConfess<Varybivore::AreGreaterThan<0>::Page, Monotony<0>, Monotony<-1>, Monotony<-2>>);
/******************************************************************************************************/
...
template<auto...Args>
requires AnyConfess<Varybivore::AreGreaterThan<0>::Page, Monotony<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyConfess<Varybivore::AreGreaterThan<1>::Page, Monotony<Args>...>
struct Tester<Args...>
{
...
template<auto...Args>
requires AnyConfess<Varybivore::AreGreaterThan<0>::Page, Monotony<Args>...>
&& AnyConfess<Varybivore::AreGreaterThan<1>::Page, Monotony<Args>...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyConfess<Varybivore::AreGreaterThan<2>::Page, Monotony<Args>...>;
