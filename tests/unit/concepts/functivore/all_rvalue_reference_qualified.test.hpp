...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_RVALUE_REFERENCE_QUALIFIED_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_RVALUE_REFERENCE_QUALIFIED_H

#include "conceptrodon/concepts/functivore/all_rvalue_reference_qualified.hpp"
