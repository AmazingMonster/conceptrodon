...
#ifndef CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_RVALUE_REFERENCE_QUALIFIED_H
#define CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_RVALUE_REFERENCE_QUALIFIED_H

#include "conceptrodon/metafunctions/functivore/concepts/all_rvalue_reference_qualified.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllRvalueReferenceQualified {
...
/******************************************************************************************************/
static_assert(AllRvalueReferenceQualified<decltype(&Tester::gun_4), FO_8>);

static_assert(! AllRvalueReferenceQualified<decltype(fun_0), decltype(&Tester::gun_4), FO_8>);
/******************************************************************************************************/
