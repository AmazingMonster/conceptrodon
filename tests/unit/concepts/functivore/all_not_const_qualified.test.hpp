...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_CONST_QUALIFIED_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_CONST_QUALIFIED_H

#include "conceptrodon/concepts/functivore/all_not_const_qualified.hpp"
