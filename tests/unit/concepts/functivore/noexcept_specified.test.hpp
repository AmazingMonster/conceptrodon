...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_NOEXCEPT_SPECIFIED_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_NOEXCEPT_SPECIFIED_H

#include "conceptrodon/concepts/functivore/noexcept_specified.hpp"
