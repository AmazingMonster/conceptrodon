...
#ifndef CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_NOT_LVALUE_REFERENCE_QUALIFIED_H
#define CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_NOT_LVALUE_REFERENCE_QUALIFIED_H

#include "conceptrodon/metafunctions/functivore/concepts/all_not_lvalue_reference_qualified.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllNotLvalueReferenceQualified {
...
static_assert
(
    AllNotLvalueReferenceQualified
    <
        decltype(fun_0),
        decltype(fun_1),
        decltype(fun_2),
