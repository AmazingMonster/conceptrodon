...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_SAME_VARIADIC_TYPE_SIGNATURE_AS_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_SAME_VARIADIC_TYPE_SIGNATURE_AS_H

#include "conceptrodon/concepts/functivore/same_variadic_type_signature_as.hpp"
