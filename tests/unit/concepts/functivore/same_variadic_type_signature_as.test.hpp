...
#ifndef CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_SAME_VARIADIC_TYPE_SIGNATURE_AS_H
#define CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_SAME_VARIADIC_TYPE_SIGNATURE_AS_H

#include "conceptrodon/metafunctions/functivore/concepts/same_variadic_type_signature_as.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestSameVariadicTypeSignatureAs {
...
consteval bool pun(SameVariadicTypeSignatureAs<decltype(fun_1)> auto arg) {return true;}

consteval bool bun(auto arg) {return false;};
consteval bool bun(SameVariadicTypeSignatureAs<decltype(fun_3)> auto arg) {return true;}

consteval bool sun(auto arg) {return false;};
consteval bool sun(SameVariadicTypeSignatureAs<decltype(fun_0)> auto arg) {return true;}
/******************************************************************************************************/
...
static_assert(sun(FunP_0));
static_assert(sun(FunAddr_0));
static_assert(sun(&Tester::fun_0));
static_assert(sun(FO_0{}));
static_assert(sun(Lambda_0));
...
static_assert(! sun(fun_1));
static_assert(! sun(fun_2));
static_assert(! sun(FunP_1));
static_assert(! sun(FunP_2));
static_assert(! sun(FunAddr_1));
static_assert(! sun(FunAddr_2));
static_assert(! sun(&Tester::fun_1));
static_assert(! sun(&Tester::fun_2));
static_assert(! sun(FO_1{}));
static_assert(! sun(FO_2{}));
static_assert(! sun(Lambda_1));
static_assert(! sun(Lambda_2));

static_assert(! sun(fun_3));
static_assert(! sun(FunP_3));
static_assert(! sun(FunAddr_3));
static_assert(! sun(&Tester::fun_3));
static_assert(! sun(FO_3{}));
static_assert(! sun(FO_4{}));
static_assert(! sun(FO_5{}));
static_assert(! sun(FO_6{}));
static_assert(! sun(FO_7{}));
static_assert(! sun(FO_8{}));
static_assert(! sun(Lambda_3));
static_assert(! sun(Lambda_4));
/******************************************************************************************************/
