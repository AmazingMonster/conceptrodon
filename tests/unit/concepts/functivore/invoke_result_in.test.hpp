...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_INVOKE_RESULT_IN_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_INVOKE_RESULT_IN_H

#include "conceptrodon/concepts/functivore/invoke_result_in.hpp"
