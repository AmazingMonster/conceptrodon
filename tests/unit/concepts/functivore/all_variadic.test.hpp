...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_VARIADIC_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_VARIADIC_H

#include "conceptrodon/concepts/functivore/all_variadic.hpp"
