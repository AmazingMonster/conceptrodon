...
#ifndef CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_NOT_VOLATILE_QUALIFIED_H
#define CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_NOT_VOLATILE_QUALIFIED_H

#include "conceptrodon/metafunctions/functivore/concepts/all_not_volatile_qualified.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllNotVolatileQualified {
