...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_MEMBER_FUNCTION_POINTER_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_MEMBER_FUNCTION_POINTER_H

#include "conceptrodon/concepts/functivore/all_not_member_function_pointer.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllNotMemberFunctionPointer {
