...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_FUNCTION_POINTER_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_FUNCTION_POINTER_H

#include "conceptrodon/concepts/functivore/all_function_pointer.hpp"
