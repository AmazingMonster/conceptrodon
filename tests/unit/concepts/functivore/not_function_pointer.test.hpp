...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_NOT_FUNCTION_POINTER_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_NOT_FUNCTION_POINTER_H

#include "conceptrodon/concepts/functivore/not_function_pointer.hpp"
