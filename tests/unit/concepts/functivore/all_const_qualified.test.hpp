...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_CONST_QUALIFIED_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_CONST_QUALIFIED_H

#include "conceptrodon/concepts/functivore/all_const_qualified.hpp"
