...
#ifndef CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_CONST_QUALIFIED_H
#define CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_CONST_QUALIFIED_H

#include "conceptrodon/metafunctions/functivore/concepts/all_const_qualified.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllConstQualified {
