...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_VARIADIC_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_VARIADIC_H

#include "conceptrodon/concepts/functivore/all_not_variadic.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllNotVariadic {
