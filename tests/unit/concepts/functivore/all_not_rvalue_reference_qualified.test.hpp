...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_RVALUE_REFERENCE_QUALIFIED_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOT_RVALUE_REFERENCE_QUALIFIED_H

#include "conceptrodon/concepts/functivore/all_not_rvalue_reference_qualified.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllNotRvalueReferenceQualified {
...
static_assert
(
    AllNotRvalueReferenceQualified
    <
        decltype(fun_0),
        decltype(fun_1),
        decltype(fun_2),
