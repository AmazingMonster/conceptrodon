...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_SAME_TYPE_SIGNATURE_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_SAME_TYPE_SIGNATURE_H

#include "conceptrodon/concepts/functivore/all_same_type_signature.hpp"
