...
#ifndef CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOEXCEPT_SPECIFIED_H
#define CONCEPTRODON_FUNCTIVORE_UNIT_TESTS_TEST_ALL_NOEXCEPT_SPECIFIED_H

#include "conceptrodon/concepts/functivore/all_noexcept_specified.hpp"
