...
#ifndef CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_NOEXCEPT_SPECIFIED_H
#define CONCEPTRODON_TESTS_UNIT_FUNCTIVORE_ALL_NOEXCEPT_SPECIFIED_H

#include "conceptrodon/metafunctions/functivore/concepts/all_noexcept_specified.hpp"

namespace Conceptrodon {
namespace Functivore {
namespace UnitTests {
namespace TestAllNoexceptSpecified {
