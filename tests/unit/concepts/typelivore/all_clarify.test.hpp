...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ALL_CLARIFY_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ALL_CLARIFY_H

#include "conceptrodon/concepts/typelivore/all_clarify.hpp"
