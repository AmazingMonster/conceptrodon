...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ALL_FAILED_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ALL_FAILED_H

#include "conceptrodon/concepts/typelivore/all_failed.hpp"
...
/******************************************************************************************************/
static_assert(AllFailed<AreNoGreaterThan<0>, 1, 2, 3>);
static_assert(! AllFailed<AreNoGreaterThan<0>, 0, 2, 3>);
/******************************************************************************************************/
...
template<auto... Args>
requires AllFailed<AreNoGreaterThan<0>, Args...>
struct Tester<Args...>
{
...
template<auto... Args>
requires AllFailed<AreNoGreaterThan<1>, Args...>
struct Tester<Args...>
{
...
template<auto... Args>
requires AllFailed<AreNoGreaterThan<0>, Args...>
&& AllFailed<AreNoGreaterThan<1>, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AllFailed<AreNoGreaterThan<2>, Args...>;
