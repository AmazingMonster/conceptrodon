...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_PASSED_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_PASSED_H

#include "conceptrodon/concepts/typelivore/passed.hpp"
...
template<auto...Args>
requires Passed<AreGreaterThan<0>, Args...>
struct Tester<Args...>
{
...
template<auto...Args>
requires Passed<AreGreaterThan<1>, Args...>
struct Tester<Args...>
{
