...
#ifndef CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ANY_FAILED_H
#define CONCEPTRODON_TYPELIVORE_UNIT_TESTS_TEST_ANY_FAILED_H

#include "conceptrodon/concepts/typelivore/any_failed.hpp"
...
/******************************************************************************************************/
static_assert(AnyFailed<AreNoGreaterThan<0>, 1, 2, 3>);
static_assert(AnyFailed<AreNoGreaterThan<0>, 1, -2, -3>);
static_assert(! AnyFailed<AreNoGreaterThan<0>, 0, -1, -2>);
/******************************************************************************************************/
...
template<auto... Args>
requires AnyFailed<AreNoGreaterThan<0>, Args...>
struct Tester<Args...>
{
...
template<auto... Args>
requires AnyFailed<AreNoGreaterThan<1>, Args...>
struct Tester<Args...>
{
...
template<auto... Args>
requires AnyFailed<AreNoGreaterThan<0>, Args...>
&& AnyFailed<AreNoGreaterThan<1>, Args...>
struct Tester<Args...>
{
    static constexpr int value {1};
};
...
= AnyFailed<AreNoGreaterThan<2>, Args...>;
