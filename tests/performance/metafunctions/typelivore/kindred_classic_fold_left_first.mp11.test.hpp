...
#ifndef CONCEPTRODON_TYPELIVORE_PERFORMANCE_TESTS_TEST_KINDRED_CLASSIC_FOLD_LEFT_FIRST_2ND_H
#define CONCEPTRODON_TYPELIVORE_PERFORMANCE_TESTS_TEST_KINDRED_CLASSIC_FOLD_LEFT_FIRST_2ND_H
...
namespace TestKindredClassicFoldLeftFirst2nd {
...
#include "macaron/fragmental/amenity/instances/define_integral_constant_sheep.hpp"
SAME_TYPE(KindredClassicFoldLeftFirst<std::integral_constant<int, 1>, SHEEP_SPROUT(240)>::Road<BinaryOperation>);
#include "macaron/fragmental/amenity/instances/undef_integral_constant_sheep.hpp"
