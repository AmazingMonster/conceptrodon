  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td>Plan</td>
          <td>Use <code>static_cast</code> to force the types of the expressions in the concepts to be <code>bool</code></td>
        </tr>
        <tr>
          <td>Progress</td>
          <td>Done</td>
  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td>Plan</td>
          <td>Move metafunctions into 'metafunctions' directory. This is to maintain the same file structure for unit testing, documentation, and the production code</td>
        </tr>
        <tr>
          <td>Progress</td>
          <td>Done</td>
  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td>Plan</td>
          <td>Move concepts into 'concepts' directory. This is to maintain the same file structure for unit testing, documentation, and the production code</td>
        </tr>
        <tr>
          <td>Progress</td>
          <td>Done</td>
  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td>Plan</td>
          <td>Update the header guards in 'tests'. All header guards in the library are articulated to match the corresponding namespace structure</td>
        </tr>
        <tr>
          <td>Progress</td>
          <td>Done</td>
  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td>Plan</td>
          <td>Turn switches <code>#ifdef</code> into <code>#if</code> in 'tests\performance\...'</td>
        </tr>
        <tr>
          <td>Progress</td>
          <td>Done</td>
  ...
  <li>
    <table>
      <tbody>
        ...
        <tr>
          <td>Progress</td>
          <td>In progress. Finished <code>Raillivore</code>, <code>Roadrivore</code>, <code>Sequnivore</code>, <code>Stockivore</code></td>
        </tr>
      </tbody>
    </table>
  </li>
  ...
  <li>
    <table>
      <tbody>
        ...
        <tr>
          <td>Progress</td>
          <td>In progress. Finished <code>Pagelivore</code></td>
        </tr>
      </tbody>
    </table>
  </li>
  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td>Plan</td>
          <td>Add documentations for the concepts in the <code>namespace Functivore</code>.</td>
        </tr>
        <tr>
          <td>Progress</td>
          <td>Done</td>
  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td>Plan</td>
          <td>Add documentations for the metafunctions in the <code>namespace Functivore</code>.</td>
        </tr>
        <tr>
          <td>Progress</td>
          <td>Done</td>
