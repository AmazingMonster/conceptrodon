...
#ifndef CONCEPTRODON_PAGELIVORE_SHORT_REMIT_H
#define CONCEPTRODON_PAGELIVORE_SHORT_REMIT_H
...
struct ShortRemit
{
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Mold = Omennivore::Send<typename Negotiation::template Mold<Agreements...>>::template UniRail<Operation>;
    };
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Page = Omennivore::Send<typename Negotiation::template Page<Agreements...>>::template UniRail<Operation>;
    };
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Road = Omennivore::Send<typename Negotiation::template Road<Agreements...>>::template UniRail<Operation>;
    };
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Rail = Omennivore::Send<typename Negotiation::template Rail<Agreements...>>::template UniRail<Operation>;
    };
