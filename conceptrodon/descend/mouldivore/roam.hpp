...
#ifndef CONCEPTRODON_MOULDIVORE_ROAM_H
#define CONCEPTRODON_MOULDIVORE_ROAM_H
...
struct Roam
{
    ...
    struct ProtoRoad
    {
        ...
        using Road = Roam<Mold>::template ProtoRoad<Containers...>;

        template<template<auto...> class...Sequences>
        using Rail = Roam<Mold>::template ProtoRail<Sequences...>;

        template<template<template<typename...> class...> class...Warehouses>
        using Flow = Roam<Mold>::template ProtoFlow<Warehouses...>;

        template<template<template<auto...> class...> class...Stockrooms>
        using Sail = Roam<Mold>::template ProtoSail<Stockrooms...>;
    };
