...
#ifndef CONCEPTRODON_MOULDIVORE_SHORT_PAUSE_H
#define CONCEPTRODON_MOULDIVORE_SHORT_PAUSE_H
...
struct ShortPause
{
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Mold = Omennivore::Send<typename Negotiation::template Mold<Agreements...>::type>::template UniRoad<Operation>;
    };
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Page = Omennivore::Send<typename Negotiation::template Page<Agreements...>::type>::template UniRoad<Operation>;
    };
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Road = Omennivore::Send<typename Negotiation::template Road<Agreements...>::type>::template UniRoad<Operation>;
    };
    ...
    struct ProtoMold<Negotiation>
    {
        ...
        using Rail = Omennivore::Send<typename Negotiation::template Rail<Agreements...>::type>::template UniRoad<Operation>;
    };
