...
#ifndef CONCEPTRODON_OMENNIVORE_ALL_UNGLOWFUL_H
#define CONCEPTRODON_OMENNIVORE_ALL_UNGLOWFUL_H
...
concept JustAllUnglowful
= (...&&(not IsGlowful<Args>::value));

template<typename...Args>
concept AllUnglowful
=   JustAllUnglowful<Args...>
||  AllMoldful<Args...>
||  AllPageful<Args...>
||  AllRoadful<Args...>
||  AllRailful<Args...>
