...
#ifndef CONCEPTRODON_OMENNIVORE_ALL_UNDAWNFUL_H
#define CONCEPTRODON_OMENNIVORE_ALL_UNDAWNFUL_H
...
concept JustAllUndawnful
= (...&&(not IsDawnful<Args>::value));

template<typename...Args>
concept AllUndawnful
=   JustAllUndawnful<Args...>
||  AllMoldful<Args...>
||  AllPageful<Args...>
||  AllRoadful<Args...>
||  AllRailful<Args...>
