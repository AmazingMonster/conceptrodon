...
/******************************************************************************************************/
#ifndef CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_FUNCTION_NAME
#error "CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_FUNCTION_IDENTIFIER has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_COUNT
#error "CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_COUNT has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_EXTEND_FRONT_FUNCTION
#error "CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_EXTEND_FRONT_FUNCTION has not been defined"
#endif
/******************************************************************************************************/
...
#define CONCEPTRODON_CYTOPLASM_MICRO_HORSE_COUNT    \
    CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_COUNT
...
>
struct CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_FUNCTION_NAME
<
...
#undef CONCEPTRODON_CYTOPLASM_MICRO_WORLD_COUNT
        ...
        ->  CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_EXTEND_FRONT_FUNCTION
        <
            decltype
            (
                CONCEPTRODON_OMINUCI_CLASSIC_MODIFY_TYPES_FUNCTION_NAME <RestIndexSequences ...>
...
#define CONCEPTRODON_CYTOPLASM_MICRO_PLAIN_MIDDLE_SYMBOLS   \
    )::type..., typename Acne<typename decltype(

#define CONCEPTRODON_CYTOPLASM_MICRO_PLAIN_SUFFIX_SYMBOLS   \
    )::type >:: CONCEPTRODON_NUCLEOLUS_TYPE_RESULT
