...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_KINDRED_FIND_PREDICATES_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_KINDRED_FIND_PREDICATES_IDENTIFIER has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_KINDRED_FIND_REST_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_KINDRED_FIND_REST_PARAMETER_IDENTIFIER has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
[]() -> CONCEPTRODON_VARBOLA_KINDRED_FIND_RESULT_INTEGRAL_TYPE
{
            
#define CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_TAIL_PREFIX_SYMBOLS  \
    if constexpr ( (...&& CONCEPTRODON_VARBOLA_KINDRED_FIND_PREDICATES_IDENTIFIER <
...
#undef CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_TAIL_COUNT
    ...
    (
        0 <= CONCEPTRODON_VARBOLA_KINDRED_FIND_FUNCTION_NAME 
    ...
    {
        return CONCEPTRODON_VARBOLA_KINDRED_FIND_LENGTH
        + CONCEPTRODON_VARBOLA_KINDRED_FIND_FUNCTION_NAME 
        < CONCEPTRODON_VARBOLA_KINDRED_FIND_REST_PARAMETER_IDENTIFIER ...>
        ::template CONCEPTRODON_NUCLEOLUS_RAIL_PROTO_TEMPLATE
        < CONCEPTRODON_VARBOLA_KINDRED_FIND_PREDICATES_IDENTIFIER ...>
        :: CONCEPTRODON_NUCLEOLUS_VALUE_RESULT ;
