...
/******************************************************************************************************/
#ifndef CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_H
#define CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_H
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_FUNCTION_NAME
#error "CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_FUNCTION_NAME has already been defined"
#endif

#define CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_FUNCTION_NAME   \
    ClassicFoldLeft
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_PARAMETER_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_PARAMETER_IDENTIFIER   \
    Operation
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_INITIAL_ELEMENT_IDENTIFIER
#error "CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_INITIAL_ELEMENT_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_INITIAL_ELEMENT_IDENTIFIER   \
    FirstElement
/******************************************************************************************************/
...
<
    ...
    CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_PARAMETER_IDENTIFIER
>
struct CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_FUNCTION_NAME
{
    template
    < 
        CONCEPTRODON_NUCLEOLUS_MOLD_PARAMETER_CATEGORY
        CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_INITIAL_ELEMENT_IDENTIFIER
    >
    struct CONCEPTRODON_NUCLEOLUS_MOLD_PROTO_TEMPLATE
    {

#include "conceptrodon/metafunctions/microbiota/moldiae/classic_fold_left/classic_fold_left.hpp"
...
/******************************************************************************************************/
#undef CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_FUNCTION_NAME
#undef CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_PARAMETER_IDENTIFIER
#undef CONCEPTRODON_MOLDIAE_CLASSIC_FOLD_LEFT_INITIAL_ELEMENT_IDENTIFIER
/******************************************************************************************************/
