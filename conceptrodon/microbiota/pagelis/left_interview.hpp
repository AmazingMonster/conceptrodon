...
/******************************************************************************************************/
#ifndef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_H
#define CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_H
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_FUNCTION_NAME
#error "CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_FUNCTION_NAME has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_FUNCTION_NAME   \
    LeftInterview
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_PARAMETER_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_PARAMETER_IDENTIFIER   \
    Predicate
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_INTERVIEWER_IDENTIFIER
#error "CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_INTERVIEWER_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_INTERVIEWER_IDENTIFIER   \
    Interviewer
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_RESULT_INTEGRAL_TYPE
#error "CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_RESULT_INTEGRAL_TYPE has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_RESULT_INTEGRAL_TYPE   \
...
<
    ...
    CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_PARAMETER_IDENTIFIER
>
struct CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_FUNCTION_NAME
{
    template
    < 
        CONCEPTRODON_NUCLEOLUS_PAGE_PARAMETER_CATEGORY
        CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_INTERVIEWER_IDENTIFIER
    >
    struct CONCEPTRODON_NUCLEOLUS_PAGE_PROTO_TEMPLATE
    {
        struct CONCEPTRODON_NUCLEOLUS_SLASH_SEPARATOR
        {
#include "conceptrodon/microbiota/pagelis/left_interview/left_interview.hpp"
        };
...
/******************************************************************************************************/
#undef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_FUNCTION_NAME
#undef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_PARAMETER_IDENTIFIER
#undef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_INTERVIEWER_IDENTIFIER
#undef CONCEPTRODON_PAGELIS_LEFT_INTERVIEW_RESULT_INTEGRAL_TYPE
/******************************************************************************************************/
