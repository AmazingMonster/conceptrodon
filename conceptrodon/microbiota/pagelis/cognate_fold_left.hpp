...
/******************************************************************************************************/
#ifndef CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_H
#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_H
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_FUNCTION_NAME
#error "CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_FUNCTION_NAME has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_FUNCTION_NAME   \
    CognateFoldLeft
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_PARAMETER_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_PARAMETER_IDENTIFIER   \
    Operation
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_INITIAL_VARIABLE_IDENTIFIER
#error "CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_INITIAL_VARIABLE_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_INITIAL_VARIABLE_IDENTIFIER   \
    FirstVariable
/******************************************************************************************************/
...
>
struct CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_FUNCTION_NAME
{
    template
    < 
    ...
    struct CONCEPTRODON_NUCLEOLUS_PAGE_PROTO_TEMPLATE
    {
        ...
        {
#include "conceptrodon/microbiota/pagelis/cognate_fold_left/cognate_fold_left.hpp"
        };
...
/******************************************************************************************************/
#undef CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_FUNCTION_NAME
#undef CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_PARAMETER_IDENTIFIER
#undef CONCEPTRODON_PAGELIS_COGNATE_FOLD_LEFT_INITIAL_VARIABLE_IDENTIFIER
/******************************************************************************************************/
