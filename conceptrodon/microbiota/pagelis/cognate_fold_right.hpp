...
/******************************************************************************************************/
#ifndef CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_H
#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_H
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FUNCTION_NAME
#error "CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FUNCTION_NAME has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FUNCTION_NAME   \
    CognateFoldRight
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_PARAMETER_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_PARAMETER_IDENTIFIER   \
    Operation
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER
#error "CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER   \
    FinalVariable
/******************************************************************************************************/
...
<
    ...
    CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_PARAMETER_IDENTIFIER
>
struct CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FUNCTION_NAME
{
    template
    < 
        CONCEPTRODON_NUCLEOLUS_PAGE_PARAMETER_CATEGORY
        CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER
    >
    struct CONCEPTRODON_NUCLEOLUS_PAGE_PROTO_TEMPLATE
    {
        struct CONCEPTRODON_NUCLEOLUS_SLASH_SEPARATOR
        {
#include "conceptrodon/microbiota/pagelis/cognate_fold_right/cognate_fold_right.hpp"
        };
...
/******************************************************************************************************/
#undef CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FUNCTION_NAME
#undef CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_PARAMETER_IDENTIFIER
#undef CONCEPTRODON_PAGELIS_COGNATE_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER
/******************************************************************************************************/
