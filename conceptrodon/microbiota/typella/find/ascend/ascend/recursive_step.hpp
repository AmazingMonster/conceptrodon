...
/******************************************************************************************************/
#ifndef CONCEPTRODON_TYPELLA_FIND_PREDICATE_IDENTIFIER
#error "CONCEPTRODON_TYPELLA_FIND_PREDICATE_IDENTIFIER has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_TYPELLA_FIND_LENGTH
#error "CONCEPTRODON_TYPELLA_FIND_LENGTH has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_TYPELLA_FIND_REST_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_TYPELLA_FIND_REST_PARAMETER_IDENTIFIER has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_TYPELLA_FIND_RESULT_INTEGRAL_TYPE
#error "CONCEPTRODON_TYPELLA_FIND_RESULT_INTEGRAL_TYPE has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
[]() -> CONCEPTRODON_TYPELLA_FIND_RESULT_INTEGRAL_TYPE
{
            
#define CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_TAIL_PREFIX_SYMBOLS  \
    if constexpr ( CONCEPTRODON_TYPELLA_FIND_PREDICATE_IDENTIFIER <
...
#define CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_TAIL_COUNT   \
    CONCEPTRODON_TYPELLA_FIND_LENGTH
...
#undef CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_TAIL_COUNT
    ...
    (
        0 <= CONCEPTRODON_TYPELLA_FIND_FUNCTION_NAME 
        < CONCEPTRODON_TYPELLA_FIND_REST_PARAMETER_IDENTIFIER ...>
        ::template CONCEPTRODON_NUCLEOLUS_ROAD_PROTO_TEMPLATE <Predicate>
        :: CONCEPTRODON_NUCLEOLUS_VALUE_RESULT
    )
    {
        return CONCEPTRODON_TYPELLA_FIND_LENGTH
        + CONCEPTRODON_TYPELLA_FIND_FUNCTION_NAME 
        < CONCEPTRODON_TYPELLA_FIND_REST_PARAMETER_IDENTIFIER... >
        ::template CONCEPTRODON_NUCLEOLUS_ROAD_PROTO_TEMPLATE <Predicate>
        :: CONCEPTRODON_NUCLEOLUS_VALUE_RESULT ;
    }
