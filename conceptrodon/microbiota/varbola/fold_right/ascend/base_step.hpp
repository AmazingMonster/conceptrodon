...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_FOLD_RIGHT_FUNCTION_NAME
#error "CONCEPTRODON_VARBOLA_FOLD_RIGHT_FUNCTION_NAME has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_FOLD_RIGHT_AMOUNT
#error "CONCEPTRODON_VARBOLA_FOLD_RIGHT_AMOUNT has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_VARBOLA_FOLD_RIGHT_OPERATION_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_FOLD_RIGHT_OPERATION_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_VARBOLA_FOLD_RIGHT_OPERATION_IDENTIFIER   \
    Operation
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_VARBOLA_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_VARBOLA_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER   \
    FinalVariable
/******************************************************************************************************/
...
#define CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_COUNT    \
    CONCEPTRODON_VARBOLA_FOLD_RIGHT_AMOUNT
...
>
struct CONCEPTRODON_VARBOLA_FOLD_RIGHT_FUNCTION_NAME
<
...
>
{
    ...
    <
        CONCEPTRODON_NUCLEOLUS_PAGE_PARAMETER_CATEGORY
        CONCEPTRODON_VARBOLA_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER
    >
    struct CONCEPTRODON_NUCLEOLUS_PAGE_PROTO_TEMPLATE
    {
        ...
        <
            ...
            CONCEPTRODON_VARBOLA_FOLD_RIGHT_OPERATION_IDENTIFIER
        >
        struct CONCEPTRODON_NUCLEOLUS_RAIL_PROTO_TEMPLATE
        {
            static constexpr auto CONCEPTRODON_NUCLEOLUS_VALUE_RESULT
            = 
#include "conceptrodon/microbiota/varbola/fold_right/ascend/ascend/base_step.hpp"
            ;
        };
...
/******************************************************************************************************/
#undef CONCEPTRODON_VARBOLA_FOLD_RIGHT_OPERATION_IDENTIFIER
#undef CONCEPTRODON_VARBOLA_FOLD_RIGHT_FINAL_VARIABLE_IDENTIFIER
/******************************************************************************************************/
