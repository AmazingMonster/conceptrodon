...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_FIND_FUNCTION_NAME
#error "CONCEPTRODON_VARBOLA_FIND_FUNCTION_NAME has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER   \
    RestVariables
/******************************************************************************************************/
...
#define CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_COUNT    \
    CONCEPTRODON_VARBOLA_FIND_LENGTH
...
#undef CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_COUNT
    ...
    , CONCEPTRODON_NUCLEOLUS_PAGE_PARAMETER_CATEGORY
    ... CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER
>
struct CONCEPTRODON_VARBOLA_FIND_FUNCTION_NAME
<
...
#undef CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER
/******************************************************************************************************/
