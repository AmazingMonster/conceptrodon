...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
[]() -> CONCEPTRODON_VARBOLA_FIND_RESULT_INTEGRAL_TYPE
{
...
#undef CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_TAIL_COUNT
    ...
    (
        0 <= CONCEPTRODON_VARBOLA_FIND_FUNCTION_NAME 
        < CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER ...>
        ::template CONCEPTRODON_NUCLEOLUS_RAIL_PROTO_TEMPLATE <Predicate>
        :: CONCEPTRODON_NUCLEOLUS_VALUE_RESULT
    )
    {
        return CONCEPTRODON_VARBOLA_FIND_LENGTH
        + CONCEPTRODON_VARBOLA_FIND_FUNCTION_NAME 
        < CONCEPTRODON_VARBOLA_FIND_REST_PARAMETER_IDENTIFIER ...>
        ::template CONCEPTRODON_NUCLEOLUS_RAIL_PROTO_TEMPLATE <Predicate>
        :: CONCEPTRODON_NUCLEOLUS_VALUE_RESULT ;
    }
