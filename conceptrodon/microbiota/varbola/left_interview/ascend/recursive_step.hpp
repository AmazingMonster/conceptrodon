...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_FUNCTION_NAME
#error "CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_FUNCTION_NAME has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_RESULT_INTEGRAL_TYPE
#error "CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_RESULT_INTEGRAL_TYPE has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_LENGTH
#error "CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_LENGTH has not been defined"
#endif
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_PREDICATES_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_PREDICATES_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_PREDICATES_IDENTIFIER  \
    Predicates
/******************************************************************************************************/
...
/******************************************************************************************************/
#ifdef CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_REST_PARAMETER_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_REST_PARAMETER_IDENTIFIER has already been defined"
#endif

#define CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_REST_PARAMETER_IDENTIFIER  \
    RestVariables
/******************************************************************************************************/
...
#define CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_COUNT    \
    CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_LENGTH
...
#undef CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_COUNT
    ...
    , CONCEPTRODON_NUCLEOLUS_PAGE_PARAMETER_CATEGORY
    ... CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_REST_PARAMETER_IDENTIFIER

>
struct CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_FUNCTION_NAME
<
...
>
{
    ...
    struct CONCEPTRODON_NUCLEOLUS_PAGE_PROTO_TEMPLATE
    {
        ...
        <
            ...
            ... CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_PREDICATES_IDENTIFIER
        >
        struct CONCEPTRODON_NUCLEOLUS_RAIL_PROTO_TEMPLATE
        {
            static constexpr CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_RESULT_INTEGRAL_TYPE
