...
/******************************************************************************************************/
#ifndef CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_PREDICATE_IDENTIFIER
#error "CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_PREDICATE_IDENTIFIER has not been defined"
#endif
/******************************************************************************************************/
...
#define CONCEPTRODON_CYTOPLASM_MICRO_SHEEP_TAIL_PREFIX_SYMBOLS  \
    if constexpr (  \
    CONCEPTRODON_VARBOLA_LEFT_INTERVIEW_PREDICATE_IDENTIFIER    \
